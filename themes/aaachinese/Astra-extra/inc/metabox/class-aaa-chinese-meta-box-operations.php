<?php
/**
 * AAA Chinese Meta Box Operations
 *
 * @package     AAA Chinese
 *
 ...
 * Meta Box
 */
if ( ! class_exists( 'AAA_Chinese_Meta_Box_Operations' ) ) {

	/**
	 * Meta Box
	 */
	class AAA_Chinese_Meta_Box_Operations {
		/**
		 * Instance
		 *
		 * @var $instance
		...
		public function meta_hooks() {
			...
			if ( is_singular() ) {
				...
				add_filter( 'aaa_chinese_the_title_enabled', array( $this, 'post_title' ) );
		...
		public function primary_header() {
			...
			$display_header = apply_filters( 'aaa_chinese_main_header_display', $display_header );
 ...
 */
AAA_Chinese_Meta_Box_Operations::get_instance();
