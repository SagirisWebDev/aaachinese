...
if ( ! class_exists( 'Astra_Edd_Archive_Layout_Configs' ) ) {
	...
	class Astra_Edd_Archive_Layout_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$grid_ast_divider = defined( 'AAA_EXT_VER' ) && Astra_Ext_Extension::is_active( 'edd' ) ? array() : array( 'ast_class' => 'ast-top-section-divider' );
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[edd-archive-grids]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[edd-archive-product-structure-divider]',
					'section'  => 'section-edd-archive',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[edd-archive-product-structure]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[edd-archive-button-divider]',
					'section'  => 'section-edd-archive',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[edd-archive-add-to-cart-button-text]',
					'type'     => 'control',
					'control'  => 'text',
					'section'  => 'section-edd-archive',
					...
					'context'  => array(
						...
						array(
							'setting'  => AAA_THEME_SETTINGS . '[edd-archive-product-structure]',
							'operator' => 'contains',
							'value'    => 'add_cart',
						),
					),
				...
				array(
					'name'       => AAA_THEME_SETTINGS . '[edd-archive-variable-button]',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[edd-archive-variable-button-text]',
					'type'     => 'control',
					'control'  => 'text',
					...
					'context'  => array(
						Astra_Builder_Helper::$general_tab_config,
						array(
							'setting'  => AAA_THEME_SETTINGS . '[edd-archive-variable-button]',
							'operator' => '==',
							'value'    => 'button',
						),
					),
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[edd-archive-width]',
				 ...
				 */
				array(
					'name'        => AAA_THEME_SETTINGS . '[edd-archive-max-width]',
					'type'        => 'control',
					'control'     => 'ast-slider',
					'section'     => 'section-edd-archive',
					...
					'context'     => array(
						Astra_Builder_Helper::$general_tab_config,
						array(
							'setting'  => AAA_THEME_SETTINGS . '[edd-archive-width]',
							'operator' => '===',
							'value'    => 'custom',
						),
					),
			...
			if ( astra_showcase_upgrade_notices() ) {
				...
				$_configs[] =
					 ...
					 */
					array(
						'name'     => AAA_THEME_SETTINGS . '[edd-product-archive-button-link]',
						'type'     => 'control',
