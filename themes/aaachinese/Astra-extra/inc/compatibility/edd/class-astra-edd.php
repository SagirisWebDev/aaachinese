...
if ( ! class_exists( 'Astra_Edd' ) ) {
	...
	class Astra_Edd {
		...
		public function __construct() {
			...
			require_once AAA_THEME_DIR . 'inc/compatibility/edd/edd-common-functions.php';// phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
		...
		public function header_cart_icon_markup() {
			...
			if ( false === Astra_Builder_Helper::$is_header_footer_builder_active && ! defined( 'AAA_EXT_VER' ) ) {
				return;
			}
			...
			if ( 'default' === $icon || ! defined( 'AAA_EXT_VER' ) || ( defined( 'AAA_EXT_VER' ) && ! Astra_Ext_Extension::is_active( 'edd' ) ) ) {
		...
		public function customize_register( $wp_customize ) {
			 ...
			 */
			require AAA_THEME_DIR . 'inc/compatibility/edd/customizer/class-aaa-chinese-customizer-register-edd-section.php';

			/**
			 * Sections
			 */
			require AAA_THEME_DIR . 'inc/compatibility/edd/customizer/sections/class-aaa-chinese-edd-container-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/edd/customizer/sections/class-aaa-chinese-edd-sidebar-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/edd/customizer/sections/layout/class-aaa-chinese-edd-archive-layout-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/edd/customizer/sections/layout/class-aaa-chinese-edd-single-product-layout-configs.php';
