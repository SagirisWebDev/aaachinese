...
if ( ! class_exists( 'Astra_LearnDash' ) ) {
	...
	class Astra_LearnDash {
		...
		public function customize_register( $wp_customize ) {
			 ...
			 */
			require AAA_THEME_DIR . 'inc/compatibility/learndash/customizer/class-aaa-chinese-customizer-register-learndash-section.php';

			/**
			 * Sections
			 */
			require AAA_THEME_DIR . 'inc/compatibility/learndash/customizer/sections/class-aaa-chinese-learndash-container-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/learndash/customizer/sections/class-aaa-chinese-learndash-sidebar-configs.php';

			if ( 'ld30' !== $active_ld_theme ) {
				require AAA_THEME_DIR . 'inc/compatibility/learndash/customizer/sections/layout/class-aaa-chinese-learndash-general-configs.php';
			}
