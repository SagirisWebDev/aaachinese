...
if ( ! class_exists( 'Astra_LifterLMS' ) ) {
	...
	class Astra_LifterLMS {
		...
		public function customize_register( $wp_customize ) {
			 ...
			 */
			require AAA_THEME_DIR . 'inc/compatibility/lifterlms/customizer/class-aaa-chinese-liferlms-section-configs.php';

			/**
			 * Sections
			 */
			require AAA_THEME_DIR . 'inc/compatibility/lifterlms/customizer/sections/class-aaa-chinese-lifter-container-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/lifterlms/customizer/sections/class-aaa-chinese-lifter-sidebar-configs.php';
			require AAA_THEME_DIR . 'inc/compatibility/lifterlms/customizer/sections/layout/class-aaa-chinese-lifter-general-configs.php';
