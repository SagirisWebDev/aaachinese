...
if ( ! class_exists( 'Astra_Lifter_Sidebar_Configs' ) ) {
	...
	class Astra_Lifter_Sidebar_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			if ( defined( 'AAA_EXT_VER' ) && Astra_Ext_Extension::is_active( 'lifterlms' ) ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[lifterlms-sidebar-layout]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[lifterlms-sidebar-style]',
					'type'       => 'control',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[lifterlms-course-lesson-sidebar-layout]',
					'type'              => 'control',
					'control'           => 'ast-radio-image',
					'sanitize_callback' => array( 'Astra_Customizer_Sanitizes', 'sanitize_choices' ),
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[lifterlms-course-lesson-sidebar-style]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => $section_courses,
