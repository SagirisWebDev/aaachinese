	...
	class Astra_Lifter_General_Configs extends Astra_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[llms-course-grid-divider]',
					'section'  => $section,
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[llms-course-grid]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[llms-membership-grid]',
					'type'              => 'control',
					'control'           => 'ast-responsive-slider',
					'sanitize_callback' => array( 'Astra_Customizer_Sanitizes', 'sanitize_responsive_slider' ),
					'section'           => $section,
			...
			if ( astra_showcase_upgrade_notices() ) {
				...
				$_configs[] =
					 ...
					 */
					array(
						'name'     => AAA_THEME_SETTINGS . '[llms-button-link]',
						'type'     => 'control',
