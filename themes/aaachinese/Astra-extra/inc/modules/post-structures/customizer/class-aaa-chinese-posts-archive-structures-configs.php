 ...
 * @since 4.0.0
 */
class AAA_Chinese_Posts_Archive_Structures_Configs extends AAA_Chinese_Customizer_Config_Base {
	/**
	...
	public function get_layout_configuration( $parent_section, $post_type ) {
		...
		if ( defined( 'AAA_EXT_VER' ) && AAA_Chinese_Ext_Extension::is_active( 'blog-pro' ) && ! ( 'post' === $post_type || 'product' === $post_type || 'buddypress' === $post_type ) ) {
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$reveal_effect = array(
				'name'     => AAA_THEME_SETTINGS . '[archive-' . $post_type . '-ast-reveal-effect]',
				'section'  => $parent_section,
				'type'     => 'control',
				'control'  => 'ast-toggle-control',
				'default'  => aaa_chinese_get_option( 'archive-' . $post_type . '-ast-reveal-effect', false ),
		...
		return array(
			 ...
			 */
			array(
				'name'              => AAA_THEME_SETTINGS . '[archive-' . $post_type . '-ast-content-layout]',
				'type'              => 'control',
				'control'           => 'ast-radio-image',
				'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_choices' ),
				'section'           => $parent_section,
				'default'           => aaa_chinese_get_option( 'archive-' . $post_type . '-ast-content-layout', 'default' ),
				'priority'          => 5,
			 ...
			 */
			array(
				'name'        => AAA_THEME_SETTINGS . '[archive-' . $post_type . '-content-style]',
				'type'        => 'control',
				'control'     => 'ast-selector',
				'section'     => $parent_section,
				'default'     => aaa_chinese_get_option( 'archive-' . $post_type . '-content-style', 'default' ),
				'priority'    => 5,
			 ...
			 */
			array(
				'name'              => AAA_THEME_SETTINGS . '[archive-' . $post_type . '-sidebar-layout]',
				'type'              => 'control',
				'control'           => 'ast-radio-image',
				'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_choices' ),
				'section'           => $parent_section,
				'default'           => aaa_chinese_get_option( 'archive-' . $post_type . '-sidebar-layout', 'default' ),
				'priority'          => 5,
			 ...
			 */
			array(
				'name'       => AAA_THEME_SETTINGS . '[archive-' . $post_type . '-sidebar-style]',
				'type'       => 'control',
				'control'    => 'ast-selector',
				'section'    => $parent_section,
				'default'    => aaa_chinese_get_option( 'archive-' . $post_type . '-sidebar-style', 'default' ),
				'priority'   => 5,
	...
	public function register_configuration( $configurations, $wp_customize ) {
		...
		foreach ( $post_types as $post_type ) {
			...
			$_configs = array(
				...
				array(
					'name'     => AAA_THEME_SETTINGS . '[ast-archive-' . $post_type . '-title]',
					'type'     => 'control',
					'default'  => aaa_chinese_get_option( 'ast-archive-' . $post_type . '-title', class_exists( 'WooCommerce' ) && 'product' === $post_type ? false : true ),
				...
				array(
					...
					'section'           => $title_section,
					'context'           => AAA_Chinese_Builder_Helper::$general_tab,
					'default'           => aaa_chinese_get_option( $title_section . '-structure', array( $title_section . '-title', $title_section . '-description' ) ),
					'priority'          => 20,
				...
				array(
					...
					'default'  => aaa_chinese_get_option( $title_section . '-custom-title', '' ),
				...
				array(
					...
					'parent'      => AAA_THEME_SETTINGS . '[' . $title_section . '-structure]',
					'default'     => aaa_chinese_get_option( $title_section . '-custom-description', '' ),
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[' . $title_section . '-banner-image-type]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => $title_section,
					'default'    => aaa_chinese_get_option( $title_section . '-banner-image-type', 'none' ),
					'priority'   => 5,
					'context'    => AAA_Chinese_Builder_Helper::$design_tab,
				 ...
				 */
				array(
					'name'      => AAA_THEME_SETTINGS . '[' . $title_section . '-banner-custom-bg]',
					'default'   => aaa_chinese_get_option( $title_section . '-banner-custom-bg', AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'responsive-background' ) ),
					'type'      => 'control',
					...
					'context'   => array(
						...
						'relation' => 'AND',
						array(
							'setting'  => AAA_THEME_SETTINGS . '[' . $title_section . '-banner-image-type]',
							'operator' => '===',
							'value'    => 'custom',
						),
					),
				...
				array(
					...
					'default'           => aaa_chinese_get_option( $title_section . '-banner-padding', class_exists( 'WooCommerce' ) && 'product' === $post_type ? AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'responsive-spacing' ) : AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'responsive-padding' ) ),
					'type'              => 'control',
					'control'           => 'ast-responsive-spacing',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_responsive_spacing' ),
					'section'           => $title_section,
			...
			if ( 'post' === $post_type ) {
				 ...
				 */
				$_configs[] = array(
					'name'     => AAA_THEME_SETTINGS . '[' . $title_section . '-banner-on-blog]',
					'default'  => aaa_chinese_get_option( $title_section . '-banner-on-blog', false ),
					'type'     => 'control',
					'section'  => $title_section,
					'context'  => array(
						AAA_Chinese_Builder_Helper::$general_tab_config,
			...
			if ( 'product' === $post_type ) {
				 ...
				 */
				$_configs[] = array(
					'name'     => AAA_THEME_SETTINGS . '[' . $title_section . '-banner-featured-overlay]',
					'type'     => 'control',
					'control'  => 'ast-color',
					'section'  => $title_section,
	...
	public function get_dynamic_section_title( $post_type_object, $post_type ) {
		if ( ! is_null( $post_type_object ) ) {
			$title = 'post' === $post_type ? __( 'Blog', 'astra' ) : AAA_Chinese_Posts_Structures_Configs::aaa_chinese_get_dynamic_section_title( get_post_type_object( $post_type ), $post_type );
		} else {
			$title = __( 'Archive Banner', 'astra' );
		}
		/** @psalm-suppress TooManyArguments */
		return apply_filters( 'aaa_chinese_archive_post_title', $title . __( ' Title Area', 'astra' ), $post_type );
	}
}
 ...
 */
new AAA_Chinese_Posts_Archive_Structures_Configs();
