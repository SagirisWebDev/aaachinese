...
if ( ! class_exists( 'Astra_Builder_Loader' ) ) {
	...
	final class Astra_Builder_Loader {
		...
		public function __construct() {
			 ...
			 * Builder Core Files.
			 */
			require_once AAA_THEME_DIR . 'inc/core/builder/class-aaa-chinese-builder-helper.php';
			require_once AAA_THEME_DIR . 'inc/core/builder/class-aaa-chinese-builder-options.php';

			/**
			 * Builder - Header & Footer Markup.
			 */
			require_once AAA_THEME_DIR . 'inc/builder/markup/class-aaa-chinese-builder-header.php';
			require_once AAA_THEME_DIR . 'inc/builder/markup/class-aaa-chinese-builder-footer.php';

			/**
			 * Builder Controllers.
			 */
			require_once AAA_THEME_DIR . 'inc/builder/controllers/class-aaa-chinese-builder-widget-controller.php';
			require_once AAA_THEME_DIR . 'inc/builder/controllers/class-aaa-chinese-builder-ui-controller.php';
			/**
			 * Customizer - Configs.
			 */
			require_once AAA_THEME_DIR . 'inc/customizer/class-aaa-chinese-builder-customizer.php';
		...
		public function load_markup() {
			...
			if ( ! defined( 'AAA_ADVANCED_HOOKS_POST_TYPE' ) || false === Astra_Builder_Helper::$is_header_footer_builder_active ) {
				return;
			}
			...
			$result             = Astra_Target_Rules_Fields::get_instance()->get_posts_by_conditions( AAA_ADVANCED_HOOKS_POST_TYPE, $option );
			$header_counter     = 0;
			$footer_counter     = 0;
			...
			foreach ( $result as $post_id => $post_data ) {
				...
				if ( AAA_ADVANCED_HOOKS_POST_TYPE !== $post_type ) {
