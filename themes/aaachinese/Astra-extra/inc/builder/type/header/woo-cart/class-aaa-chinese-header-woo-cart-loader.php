...
class Astra_Header_Woo_Cart_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-header-builder-woo-cart-customizer-preview-js', AAA_HEADER_WOO_CART_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), AAA_THEME_VERSION, true );
