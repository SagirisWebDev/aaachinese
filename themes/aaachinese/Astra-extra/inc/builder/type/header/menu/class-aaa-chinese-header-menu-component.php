...
define( 'AAA_HEADER_MENU_DIR', AAA_THEME_DIR . 'inc/builder/type/header/menu' );
define( 'AAA_HEADER_MENU_URI', AAA_THEME_URI . 'inc/builder/type/header/menu' );
...
class Astra_Header_Menu_Component {
	...
	public function __construct() {
		...
		require_once AAA_HEADER_MENU_DIR . '/class-aaa-chinese-header-menu-component-loader.php';

		// Include front end files.
		if ( ! is_admin() || Astra_Builder_Customizer::astra_collect_customizer_builder_data() ) {
			require_once AAA_HEADER_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
