...
define( 'AAA_BUILDER_MOBILE_MENU_DIR', AAA_THEME_DIR . 'inc/builder/type/header/mobile-menu' );
define( 'AAA_BUILDER_MOBILE_MENU_URI', AAA_THEME_URI . 'inc/builder/type/header/mobile-menu' );
...
class Astra_Mobile_Menu_Component {
	...
	public function __construct() {
		...
		require_once AAA_BUILDER_MOBILE_MENU_DIR . '/class-aaa-chinese-mobile-menu-component-loader.php';

		// Include front end files.
		if ( ! is_admin() || Astra_Builder_Customizer::astra_collect_customizer_builder_data() ) {
			require_once AAA_BUILDER_MOBILE_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
