...
class Astra_Header_Button_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-heading-button-customizer-preview-js', AAA_HEADER_BUTTON_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), AAA_THEME_VERSION, true );
		...
		wp_localize_script(
			...
			array(
				'component_limit' => defined( 'AAA_EXT_VER' ) ? Astra_Builder_Helper::$component_limit : Astra_Builder_Helper::$num_of_header_button,
			)
		);
	}
}
