...
class Astra_Primary_Header_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-heading-primary-customizer-preview-js', AAA_PRIMARY_HEADER_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), AAA_THEME_VERSION, true );
