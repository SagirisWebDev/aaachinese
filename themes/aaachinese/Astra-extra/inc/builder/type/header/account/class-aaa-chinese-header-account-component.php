...
define( 'AAA_HEADER_ACCOUNT_DIR', AAA_THEME_DIR . 'inc/builder/type/header/account' );
define( 'AAA_HEADER_ACCOUNT_URI', AAA_THEME_URI . 'inc/builder/type/header/account' );
...
if ( ! class_exists( 'Astra_Header_Account_Component' ) ) {
	...
	class Astra_Header_Account_Component {
		...
		public function __construct() {
			...
			require_once AAA_HEADER_ACCOUNT_DIR . '/class-aaa-chinese-header-account-component-loader.php';

			// Include front end files.
			if ( ! is_admin() || Astra_Builder_Customizer::astra_collect_customizer_builder_data() ) {
				require_once AAA_HEADER_ACCOUNT_DIR . '/dynamic-css/dynamic.css.php';
			}
