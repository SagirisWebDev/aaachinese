...
define( 'AAA_HEADER_SEARCH_DIR', AAA_THEME_DIR . 'inc/builder/type/header/search' );
define( 'AAA_HEADER_SEARCH_URI', AAA_THEME_URI . 'inc/builder/type/header/search' );
...
class Astra_Header_Search_Component {
	...
	public function __construct() {
		...
		require_once AAA_HEADER_SEARCH_DIR . '/class-aaa-chinese-header-search-component-loader.php';

		// Include front end files.
		if ( ! is_admin() || Astra_Builder_Customizer::astra_collect_customizer_builder_data() ) {
			require_once AAA_HEADER_SEARCH_DIR . '/dynamic-css/dynamic.css.php';
		}
