...
class Astra_Primary_Footer_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-footer-primary-footer-customizer-preview-js', AAA_BUILDER_FOOTER_PRIMARY_FOOTER_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), AAA_THEME_VERSION, true );
