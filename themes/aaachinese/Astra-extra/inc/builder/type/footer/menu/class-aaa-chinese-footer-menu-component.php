...
define( 'AAA_BUILDER_FOOTER_MENU_DIR', AAA_THEME_DIR . 'inc/builder/type/footer/menu' );
define( 'AAA_BUILDER_FOOTER_MENU_URI', AAA_THEME_URI . 'inc/builder/type/footer/menu' );
...
class Astra_Footer_Menu_Component {
	...
	public function __construct() {
		...
		require_once AAA_BUILDER_FOOTER_MENU_DIR . '/class-aaa-chinese-footer-menu-component-loader.php';

		// Include front end files.
		if ( ! is_admin() || Astra_Builder_Customizer::astra_collect_customizer_builder_data() ) {
			require_once AAA_BUILDER_FOOTER_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
