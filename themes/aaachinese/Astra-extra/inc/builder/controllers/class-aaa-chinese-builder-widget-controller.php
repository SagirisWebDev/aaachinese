...
if ( ! class_exists( 'Astra_Builder_Widget_Controller' ) ) {
	...
	final class Astra_Builder_Widget_Controller {
		...
		public function widget_init() {
			...
			$component_limit = defined( 'AAA_EXT_VER' ) ? Astra_Builder_Helper::$component_limit : Astra_Builder_Helper::$num_of_footer_widgets;
			...
			$component_limit = defined( 'AAA_EXT_VER' ) ? Astra_Builder_Helper::$component_limit : Astra_Builder_Helper::$num_of_header_widgets;
			for ( $index = 1; $index <= $component_limit; $index++ ) {
