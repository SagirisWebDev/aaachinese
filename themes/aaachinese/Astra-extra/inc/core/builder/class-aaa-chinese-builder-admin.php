...
final class Astra_Builder_Admin {
	...
	public function migrate_to_builder() {
		...
		if ( $migrate && false === $migration_flag ) {
			require_once AAA_THEME_DIR . 'inc/theme-update/astra-builder-migration-updater.php';  // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
