<?php
/**
 * AAA Chinese BSF Analytics class helps to connect BSF Analytics.
 *
 * @package aaa-chinese
 */
...
/**
 * AAA Chinese BSF Analytics class.
 *
 * @since 4.10.0
 */
class AAA_Chinese_BSF_Analytics {
	/**
	 * Instance object.
	 *
	...
	public function __construct() {
		...
		*/
		if ( ! class_exists( 'BSF_Analytics_Loader' ) ) {
			require_once AAA_THEME_DIR . 'inc/lib/bsf-analytics/class-bsf-analytics-loader.php';
		}

		add_action( 'init', array( $this, 'init_bsf_analytics' ), 5 );
		add_filter( 'bsf_core_stats', array( $this, 'add_astra_analytics_data' ) );

		// Track AAA Chinese customizer publish events for kpi tracking.
	...
	public function init_bsf_analytics() {
		// Bail early if BSF_Analytics_Loader::get_instance is not callable and if AAA Chinese white labelling is enabled.
		...
		$bsf_analytics->set_entity(
			array(
				'astra' => array(
					'product_name'        => 'Astra',
					'path'                => AAA_THEME_DIR . 'inc/lib/bsf-analytics',
					...
					'deactivation_survey' => apply_filters(
						...
						array(
							...
							// 'popup_logo'        => AAA_THEME_URI . 'inc/assets/images/astra-logo.svg',
							// 'plugin_slug'       => 'astra',
							...
							// 'plugin_version'    => AAA_THEME_VERSION,
	...
	public function add_astra_analytics_data( $stats_data ) {
		...
		$astra_stats = array(
			'free_version'                 => AAA_THEME_VERSION,
