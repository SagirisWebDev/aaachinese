...
if ( ! class_exists( 'AAA_Chinese_Customizer_Register_Sections_Panels' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Customizer_Register_Sections_Panels extends AAA_Chinese_Customizer_Config_Base {
		/**
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$configs = array(
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/site-layout-overview/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
								array(
									'text'  => __( 'Container Overview', 'astra' ) . ' &#187;',
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/container-overview/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/site-identity-free/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/header-overview/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
				...
				array(
					...
					'priority'         => 70,
					'section_callback' => 'AAA_Chinese_WP_Customize_Separator',
				),
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/footer-bar/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/sidebar-free/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/colors-background/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
						...
						array(
							...
							'links'       => array(
								array(
									...
									'attrs' => array(
										'href' => aaa_chinese_get_pro_url( '/docs/typography-free/', 'free-theme', 'customizer', 'helpful_information' ),
									),
								),
							),
						)
			...
			foreach ( AAA_Chinese_Posts_Structure_Loader::get_special_page_types() as $index => $special_type ) {
				$configs[] = array(
 ...
 */
new AAA_Chinese_Customizer_Register_Sections_Panels();
