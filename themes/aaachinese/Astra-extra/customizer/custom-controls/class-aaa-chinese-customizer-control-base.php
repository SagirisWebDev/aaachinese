 ...
 * @since 1.4.3
 */
if ( ! class_exists( 'AAA_Chinese_Customizer_Control_Base' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Customizer_Control_Base {
		/**
		 * Registered Controls.
		 *
		 * @since 1.4.3
		...
		public function enqueue_scripts() {
			...
			$file_rtl    = is_rtl() ? '-rtl' : '';
			$css_uri     = AAA_THEME_URI . 'inc/customizer/custom-controls/assets/css/' . $dir_name . '/';
			$js_uri      = AAA_THEME_URI . 'inc/customizer/custom-controls/assets/js/unminified/';

			wp_enqueue_style( 'astra-custom-control-style' . $file_rtl, $css_uri . 'custom-controls' . $file_prefix . $file_rtl . '.css', null, AAA_THEME_VERSION );
			...
			wp_enqueue_script( 'astra-custom-control-plain-script', $js_uri . 'custom-controls-plain.js', $custom_controls_plain_deps, AAA_THEME_VERSION, true );
			...
			wp_enqueue_script( 'astra-custom-control-script', AAA_THEME_URI . 'inc/customizer/extend-custom-controls/build/index.js', $custom_controls_react_deps, AAA_THEME_VERSION, true );
			...
			$aaa_chinese_typo_localize = array(
			...
			wp_localize_script( 'astra-custom-control-script', 'astraTypo', $aaa_chinese_typo_localize );

			$css_uri = AAA_THEME_URI . 'inc/customizer/custom-controls/typography/';

			wp_enqueue_style( 'astra-select-woo-style', $css_uri . 'selectWoo.css', null, AAA_THEME_VERSION );
		}
 ...
 */
new AAA_Chinese_Customizer_Control_Base();
