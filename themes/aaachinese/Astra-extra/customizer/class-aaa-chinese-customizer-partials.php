 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'AAA_Chinese_Customizer_Partials' ) ) {

	/**
	 * Customizer Partials initial setup
	 */
	class AAA_Chinese_Customizer_Partials {
		/**
		 * Constructor
		 *
		 * @since 1.0.0
		...
		public static function render_partial_site_tagline() {
			...
			$site_tagline_setting = aaa_chinese_get_option( 'display-site-tagline-responsive' );
		...
		public static function render_partial_site_title() {
			...
			$site_title_setting = aaa_chinese_get_option( 'display-site-title-responsive' );
		...
		public static function render_header_main_rt_section_html() {
			...
			$right_section_html = aaa_chinese_get_i18n_option( 'header-main-rt-section-html', _x( '%astra%', 'Primary Menu: Custom Menu Text / HTML for Last Item in Menu', 'astra' ) );
		...
		public static function render_header_main_rt_section_button_text() {
			$custom_button_text = aaa_chinese_get_i18n_option( 'header-main-rt-section-button-text', _x( '%astra%', 'Primary Menu: Button Text for Last Item in Menu', 'astra' ) );
		...
		public static function render_header_site_title_tagline() {
			...
			$html = aaa_chinese_get_site_title_tagline( $display_site_title, $display_site_tagline );
		...
		public static function render_footer_sml_section_1_credit() {
			...
			$output = aaa_chinese_get_small_footer_custom_text( 'footer-sml-section-1-credit' );
		...
		public static function render_footer_sml_section_2_credit() {
			...
			$output = aaa_chinese_get_small_footer_custom_text( 'footer-sml-section-2-credit' );
			return do_shortcode( wp_kses_post( $output ) );
		}
		...
		public static function mobile_toggle_menu() {
			...
			$output = aaa_chinese_masthead_toggle_buttons_primary();
			return do_shortcode( wp_kses_post( $output ) );
		}
	}
}
