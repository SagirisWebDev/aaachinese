 ...
 */
if ( ! class_exists( 'AAA_Chinese_Font_Families' ) ) {

	/**
	 * Font info class for System and Google fonts.
	 */
	final class AAA_Chinese_Font_Families {
		/**
		 * System Fonts
		 *
		 * @since 1.0.0
		 ...
		 * @since 1.0.0
		 *
		 * @return Array All the system fonts in AAA Chinese
		 */
		public static function get_system_fonts() {
			...
			return apply_filters( 'aaa_chinese_system_fonts', self::$system_fonts );
		}
		 ...
		 * @since 1.0.0
		 *
		 * @return Array All the custom fonts in AAA Chinese
		 */
		public static function get_custom_fonts() {
			$custom_fonts = array();

			return apply_filters( 'aaa_chinese_custom_fonts', $custom_fonts );
		}
		...
		public static function get_google_fonts() {
			...
			if ( empty( self::$google_fonts ) ) {
				 ...
				 * @return array
				 */
				$google_fonts_file = apply_filters( 'aaa_chinese_google_fonts_php_file', AAA_THEME_DIR . 'inc/google-fonts.php' );
			...
			return apply_filters( 'aaa_chinese_google_fonts', self::$google_fonts );
		}
