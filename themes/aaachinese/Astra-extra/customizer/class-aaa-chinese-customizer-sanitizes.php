<?php
/**
 * AAA Chinese Theme Customizer Sanitize.
 *
 * @package     AAA Chinese
 *
 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'AAA_Chinese_Customizer_Sanitizes' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Customizer_Sanitizes {
		/**
		 * Instance
		 *
		 * @var object
 ...
 */
AAA_Chinese_Customizer_Sanitizes::get_instance();
