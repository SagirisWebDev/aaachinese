<?php
/**
 * Entry Content options for AAA Chinese Theme.
 *
 * @package     AAA Chinese
 *
 * @since       AAA Chinese 3.8.0
 */

if ( ! class_exists( 'AAA_Chinese_Block_Editor_Configs' ) ) {

	/**
	 * Register Site Layout Customizer Configurations.
	 */
	class AAA_Chinese_Block_Editor_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register Site Layout Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$is_legacy_setup = 'legacy' === aaa_chinese_get_option( 'wp-blocks-ui', 'comfort' ) || true === aaa_chinese_get_option( 'blocks-legacy-setup', false ) ? true : false;
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[wp-blocks-ui]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => 'section-block-editor',
					'default'    => aaa_chinese_get_option( 'wp-blocks-ui' ),
					'priority'   => 9,
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[wp-blocks-global-padding]',
					'section'           => 'section-block-editor',
					'title'             => __( 'Size', 'astra' ),
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_responsive_spacing' ),
					'default'           => aaa_chinese_get_option( 'wp-blocks-global-padding' ),
					'type'              => 'control',
					...
					'context'           => array(
						array(
							'setting'  => AAA_THEME_SETTINGS . '[wp-blocks-ui]',
							'operator' => '===',
							'value'    => 'custom',
						),
					),
				...
				array(
					'name'     => AAA_THEME_SETTINGS . '[wp-blocks-ui-description]',
					'type'     => 'control',
 ...
 */
new AAA_Chinese_Block_Editor_Configs();
