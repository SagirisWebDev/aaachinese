 ...
 * @since 3.0.0
 */
class AAA_Chinese_Customizer_Copyright_Configs extends AAA_Chinese_Customizer_Config_Base {
	/**
	 * Register Builder Customizer Configurations.
	 *
	...
	public function register_configuration( $configurations, $wp_customize ) {
		$_configs = aaa_chinese_copyright_footer_configuration();
...
new AAA_Chinese_Customizer_Copyright_Configs();
