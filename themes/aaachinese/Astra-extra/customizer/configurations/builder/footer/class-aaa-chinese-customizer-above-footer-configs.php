<?php
/**
 * AAA Chinese Theme Customizer Configuration Above footer.
 *
...
if ( class_exists( 'AAA_Chinese_Customizer_Config_Base' ) ) {
	 ...
	 * @since 3.0.0
	 */
	class AAA_Chinese_Customizer_Above_Footer_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		...
		public function register_configuration( $configurations, $wp_customize ) {
			$_configs = aaa_chinese_above_footer_configuration();
	 ...
	 */
	new AAA_Chinese_Customizer_Above_Footer_Configs();
}
