 ...
 * @since 3.0.0
 */
class AAA_Chinese_Footer_Button_Component_Configs extends AAA_Chinese_Customizer_Config_Base {
	/**
	 * Register Builder Customizer Configurations.
	 *
	...
	public function register_configuration( $configurations, $wp_customize ) {
		return aaa_chinese_button_footer_configuration( $configurations );
	}
}
...
new AAA_Chinese_Footer_Button_Component_Configs();
