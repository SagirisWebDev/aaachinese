 ...
 */
function aaa_chinese_menu_footer_configuration() {
	...
	$_configs = array(
		 ...
		 */
		array(
			'name'      => AAA_THEME_SETTINGS . '[footer-create-menu-link]',
			'default'   => aaa_chinese_get_option( 'footer-create-menu-link' ),
			'type'      => 'control',
		...
		array(
			'name'       => AAA_THEME_SETTINGS . '[footer-menu-layout]',
			'default'    => aaa_chinese_get_option( 'footer-menu-layout' ),
			'section'    => $_section,
			'priority'   => 20,
			...
			'partial'    => array(
				...
				'render_callback'     => array( AAA_Chinese_Builder_Footer::get_instance(), 'footer_menu' ),
			),
			'choices'    => array(
		 ...
		 */
		array(
			'name'      => AAA_THEME_SETTINGS . '[footer-menu-alignment]',
			'default'   => aaa_chinese_get_option( 'footer-menu-alignment' ),
			'type'      => 'control',
			'control'   => 'ast-selector',
			'section'   => $_section,
			'priority'  => 21,
		...
		array(
			'name'       => AAA_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'control',
		...
		array(
			'name'       => AAA_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'control',
			'control'    => 'ast-color-group',
			'context'    => AAA_Chinese_Builder_Helper::$design_tab,
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-bg-obj-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-h-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-link-colors]',
			'tab'        => __( 'Hover', 'astra' ),
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-h-bg-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
			'title'      => __( 'Hover', 'astra' ),
			'section'    => $_section,
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-a-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'sub-control',
			'section'    => $_section,
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'footer-menu-a-bg-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
			'transport'  => 'postMessage',
		 ...
		 */
		array(
			'name'     => AAA_THEME_SETTINGS . '[footer-main-menu-divider]',
			'section'  => $_section,
		...
		// Option - Menu Space.
		array(
			'name'              => AAA_THEME_SETTINGS . '[footer-main-menu-spacing]',
			'default'           => aaa_chinese_get_option( 'footer-main-menu-spacing' ),
			'type'              => 'control',
	...
	if ( defined( 'AAA_EXT_VER' ) && AAA_Chinese_Ext_Extension::is_active( 'typography' ) ) {
		...
		$new_configs = array(
			...
			array(
				'name'      => AAA_THEME_SETTINGS . '[footer-menu-typography]',
				'default'   => aaa_chinese_get_option( 'footer-menu-typography' ),
				'type'      => 'control',
			...
			array(
				...
				'default'           => aaa_chinese_get_option( 'footer-menu-font-size' ),
				'parent'            => AAA_THEME_SETTINGS . '[footer-menu-typography]',
				'section'           => $_section,
				'type'              => 'sub-control',
				'priority'          => 23,
		...
		$new_configs = array(
			...
			array(
				'name'              => AAA_THEME_SETTINGS . '[footer-menu-font-size]',
				'default'           => aaa_chinese_get_option( 'footer-menu-font-size' ),
				'section'           => $_section,
				'control'           => 'ast-responsive-slider',
				'context'           => AAA_Chinese_Builder_Helper::$design_tab,
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_menu_footer_configuration' );
}
