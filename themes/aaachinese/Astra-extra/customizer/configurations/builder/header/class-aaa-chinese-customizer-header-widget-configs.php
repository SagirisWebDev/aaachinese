 ...
 * @since 3.0.0
 */
class AAA_Chinese_Customizer_Header_Widget_Configs extends AAA_Chinese_Customizer_Config_Base {
	/**
	 * Register Builder Customizer Configurations.
	 *
	...
	public function register_configuration( $configurations, $wp_customize ) {
		$html_config = aaa_chinese_header_widget_configuration();
...
new AAA_Chinese_Customizer_Header_Widget_Configs();
