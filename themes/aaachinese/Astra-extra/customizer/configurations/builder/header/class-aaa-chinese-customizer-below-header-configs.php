<?php
/**
 * AAA Chinese Theme Customizer Configuration Below Header.
 *
...
if ( class_exists( 'AAA_Chinese_Customizer_Config_Base' ) ) {
	 ...
	 * @since 3.0.0
	 */
	class AAA_Chinese_Customizer_Below_Header_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		...
		public function register_configuration( $configurations, $wp_customize ) {
			$_configs = aaa_chinese_below_header_configuration();
	 ...
	 */
	new AAA_Chinese_Customizer_Below_Header_Configs();
}
