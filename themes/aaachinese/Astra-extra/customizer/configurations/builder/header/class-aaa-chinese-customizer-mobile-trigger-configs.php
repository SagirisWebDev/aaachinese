 ...
 * @since 3.0.0
 */
class AAA_Chinese_Customizer_Mobile_Trigger_Configs extends AAA_Chinese_Customizer_Config_Base {
	/**
	 * Register Builder Customizer Configurations.
	 *
	...
	public function register_configuration( $configurations, $wp_customize ) {
		$_configs = aaa_chinese_header_mobile_trigger_configuration();
...
new AAA_Chinese_Customizer_Mobile_Trigger_Configs();
