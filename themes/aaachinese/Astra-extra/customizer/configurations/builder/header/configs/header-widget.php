 ...
 */
function aaa_chinese_header_widget_configuration() {
	$_configs = AAA_Chinese_Builder_Base_Configuration::prepare_widget_options( 'header' );
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_header_widget_configuration' );
}
