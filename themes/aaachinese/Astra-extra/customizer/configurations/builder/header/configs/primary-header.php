 ...
 */
function aaa_chinese_primary_header_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'              => AAA_THEME_SETTINGS . '[hb-header-height]',
			'section'           => $_section,
			'transport'         => 'postMessage',
			'default'           => aaa_chinese_get_option( 'hb-header-height' ),
			'priority'          => 3,
		...
		array(
			'name'        => AAA_THEME_SETTINGS . '[hb-header-bg-obj-responsive]',
			'section'     => $_section,
			'type'        => 'control',
			...
			'default'     => aaa_chinese_get_option( 'hb-header-bg-obj-responsive' ),
		...
		array(
			'name'              => AAA_THEME_SETTINGS . '[hb-header-main-sep-color]',
			'transport'         => 'postMessage',
			'default'           => aaa_chinese_get_option( 'hb-header-main-sep-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					'setting'  => AAA_THEME_SETTINGS . '[hb-header-main-sep]',
					'operator' => '>=',
					'value'    => 1,
				),
			),
		...
		array(
			'name'        => AAA_THEME_SETTINGS . '[hb-header-main-sep]',
			'transport'   => 'postMessage',
			'default'     => aaa_chinese_get_option( 'hb-header-main-sep' ),
			'type'        => 'control',
			'control'     => 'ast-slider',
			'section'     => $_section,
			'priority'    => 5,
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_primary_header_configuration' );
}
