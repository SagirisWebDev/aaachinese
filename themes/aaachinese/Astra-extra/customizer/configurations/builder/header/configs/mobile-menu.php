 ...
 */
function aaa_chinese_header_mobile_menu_configuration() {
	...
	$_configs = array(
		 ...
		 */
		array(
			'name'      => AAA_THEME_SETTINGS . '[header-mobile-menu-create-menu-link]',
			'default'   => aaa_chinese_get_option( 'header-mobile-menu-create-menu-link' ),
			'type'      => 'control',
		...
		array(
			'name'      => AAA_THEME_SETTINGS . '[header-mobile-menu-submenu-item-border]',
			'default'   => aaa_chinese_get_option( 'header-mobile-menu-submenu-item-border' ),
			'type'      => 'control',
		...
		array(
			'name'     => AAA_THEME_SETTINGS . '[header-mobile-menu-divider-colors-divider]',
			'section'  => $_section,
			'type'     => 'control',
			'control'  => 'ast-heading',
			'title'    => __( 'Item Divider', 'astra' ),
			...
			'context'  => array(
				...
				array(
					'setting'  => AAA_THEME_SETTINGS . '[header-mobile-menu-submenu-item-border]',
					'operator' => '==',
					'value'    => true,
				),
			),
		...
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-mobile-menu-submenu-item-b-size]',
			'type'        => 'control',
			'control'     => 'ast-slider',
			'default'     => aaa_chinese_get_option( 'header-mobile-menu-submenu-item-b-size' ),
			'section'     => $_section,
			'priority'    => 150,
			'transport'   => 'postMessage',
		...
		array(
			'name'              => AAA_THEME_SETTINGS . '[header-mobile-menu-submenu-item-b-color]',
			'default'           => aaa_chinese_get_option( 'header-mobile-menu-submenu-item-b-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			'transport'         => 'postMessage',
		...
		array(
			'name'       => AAA_THEME_SETTINGS . '[header-mobile-menu-link-colors]',
			'type'       => 'control',
		...
		array(
			'name'       => AAA_THEME_SETTINGS . '[header-mobile-menu-background-colors]',
			'type'       => 'control',
			'control'    => 'ast-color-group',
			...
			'divider'    => array(
				'ast_title' => '',
				'ast_class' => class_exists( 'AAA_Chinese_Ext_Extension' ) && AAA_Chinese_Ext_Extension::is_active( 'colors-and-background' ) ? 'ast-bottom-divider' : '',
			),
		),
		// Option: Menu Color.
		array(
			'name'       => 'header-mobile-menu-color-responsive',
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-link-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-bg-obj-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-background-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-h-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-link-colors]',
			'tab'        => __( 'Hover', 'astra' ),
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-h-bg-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-background-colors]',
			'type'       => 'sub-control',
			'title'      => __( 'Hover', 'astra' ),
			'section'    => $_section,
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-a-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-link-colors]',
			'type'       => 'sub-control',
			'section'    => $_section,
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => aaa_chinese_get_option( 'header-mobile-menu-a-bg-color-responsive' ),
			'parent'     => AAA_THEME_SETTINGS . '[header-mobile-menu-background-colors]',
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
			'transport'  => 'postMessage',
		 ...
		 */
		array(
			'name'     => AAA_THEME_SETTINGS . '[header-mobile-menu-header-typo-divider]',
			'type'     => 'control',
			'control'  => 'ast-heading',
			'section'  => $_section,
			'title'    => __( 'Font', 'astra' ),
		...
		array(
			'name'      => AAA_THEME_SETTINGS . '[header-mobile-menu-header-menu-typography]',
			'default'   => aaa_chinese_get_option( 'header-mobile-menu-header-menu-typography' ),
			'type'      => 'control',
		...
		array(
			...
			'default'   => aaa_chinese_get_option( 'header-mobile-menu-font-family', 'inherit' ),
			'parent'    => AAA_THEME_SETTINGS . '[header-mobile-menu-header-menu-typography]',
			'type'      => 'sub-control',
			'section'   => $_section,
			'transport' => 'postMessage',
			'control'   => 'ast-font',
		...
		array(
			...
			'default'           => aaa_chinese_get_option( 'header-mobile-menu-font-weight', 'inherit' ),
			'parent'            => AAA_THEME_SETTINGS . '[header-mobile-menu-header-menu-typography]',
			'section'           => $_section,
			'type'              => 'sub-control',
			'control'           => 'ast-font',
		...
		array(
			...
			'default'           => aaa_chinese_get_option( 'header-mobile-menu-font-size' ),
			'parent'            => AAA_THEME_SETTINGS . '[header-mobile-menu-header-menu-typography]',
			'section'           => $_section,
			'type'              => 'sub-control',
			'priority'          => 24,
		...
		array(
			...
			'priority' => 24,
			'default'  => aaa_chinese_get_option( 'font-extras-header-mobile-menu' ),
		 ...
		 */
		array(
			'name'     => AAA_THEME_SETTINGS . '[header-mobile-menu-menu-spacing-divider]',
			'section'  => $_section,
		...
		// Option - Menu Space.
		array(
			'name'              => AAA_THEME_SETTINGS . '[header-mobile-menu-menu-spacing]',
			'default'           => aaa_chinese_get_option( 'header-mobile-menu-menu-spacing' ),
			'type'              => 'control',
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_header_mobile_menu_configuration' );
}
