 ...
 */
function aaa_chinese_header_off_canvas_configuration() {
	...
	$_configs = array(
		 ...
		 */
		array(
			'name'       => AAA_THEME_SETTINGS . '[mobile-header-type]',
			'default'    => aaa_chinese_get_option( 'mobile-header-type' ),
			'type'       => 'control',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[off-canvas-move-body]',
			'default'     => aaa_chinese_get_option( 'off-canvas-move-body' ),
			'type'        => 'control',
			...
			'context'     => array(
				...
				array(
					'setting'  => AAA_THEME_SETTINGS . '[mobile-header-type]',
					'operator' => '==',
					'value'    => 'dropdown',
				),
			),
		...
		array(
			'name'     => AAA_THEME_SETTINGS . '[off-canvas-move-body-notice]',
			'type'     => 'control',
		 ...
		 */
		array(
			'name'       => AAA_THEME_SETTINGS . '[off-canvas-slide]',
			'default'    => aaa_chinese_get_option( 'off-canvas-slide' ),
			'type'       => 'control',
		 ...
		 */
		array(
			'name'       => AAA_THEME_SETTINGS . '[header-builder-menu-toggle-target]',
			'default'    => aaa_chinese_get_option( 'header-builder-menu-toggle-target' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'context'    => AAA_Chinese_Builder_Helper::$general_tab,
		 ...
		 */
		array(
			'name'       => AAA_THEME_SETTINGS . '[header-offcanvas-content-alignment]',
			'default'    => aaa_chinese_get_option( 'header-offcanvas-content-alignment' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'context'    => AAA_Chinese_Builder_Helper::$general_tab,
		...
		array(
			'name'              => AAA_THEME_SETTINGS . '[off-canvas-background]',
			'type'              => 'control',
			...
			'default'           => aaa_chinese_get_option( 'off-canvas-background' ),
			'divider'           => array( 'ast_class' => 'ast-section-spacing' ),
		),

		// Option: Off-Canvas Close Icon Color.
		array(
			'name'              => AAA_THEME_SETTINGS . '[off-canvas-close-color]',
			'transport'         => 'postMessage',
			'default'           => aaa_chinese_get_option( 'off-canvas-close-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
		...
		array(
			'name'      => AAA_THEME_SETTINGS . '[off-canvas-inner-spacing]',
			'default'   => aaa_chinese_get_option( 'off-canvas-inner-spacing' ),
			'type'      => 'control',
			'control'   => 'ast-slider',
		...
		array(
			'name'           => AAA_THEME_SETTINGS . '[off-canvas-padding]',
			'default'        => aaa_chinese_get_option( 'off-canvas-padding' ),
			'type'           => 'control',
			'transport'      => 'postMessage',
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_header_off_canvas_configuration' );
}
