 ...
 */
function aaa_chinese_header_header_builder_configuration( $configurations = array() ) {
	...
	for ( $index = 1; $index <= AAA_Chinese_Builder_Helper::$num_of_header_button; $index++ ) {
		...
		$item = array(
			'name'    => 1 === AAA_Chinese_Builder_Helper::$num_of_header_button ? 'Button' : 'Button ' . $index,
			'icon'    => 'button',
		...
		AAA_Chinese_Builder_Helper::$header_desktop_items[ 'button-' . $index ] = $item;
		AAA_Chinese_Builder_Helper::$header_mobile_items[ 'button-' . $index ]  = $item;
	}

	for ( $index = 1; $index <= AAA_Chinese_Builder_Helper::$num_of_header_html; $index++ ) {
		...
		$item = array(
			'name'    => 1 === AAA_Chinese_Builder_Helper::$num_of_header_html ? 'HTML' : 'HTML ' . $index,
			'icon'    => 'editor-code',
		...
		AAA_Chinese_Builder_Helper::$header_desktop_items[ 'html-' . $index ] = $item;
		AAA_Chinese_Builder_Helper::$header_mobile_items[ 'html-' . $index ]  = $item;
	}

	for ( $index = 1; $index <= AAA_Chinese_Builder_Helper::$num_of_header_widgets; $index++ ) {
		...
		$item = array(
			'name'    => 1 === AAA_Chinese_Builder_Helper::$num_of_header_widgets ? 'Widget' : 'Widget ' . $index,
			'icon'    => 'screenoptions',
		...
		AAA_Chinese_Builder_Helper::$header_desktop_items[ 'widget-' . $index ] = $item;
		AAA_Chinese_Builder_Helper::$header_mobile_items[ 'widget-' . $index ]  = $item;
	}
	...
	for ( $index = 1; $index <= AAA_Chinese_Builder_Helper::$num_of_header_menu; $index++ ) {
		...
		AAA_Chinese_Builder_Helper::$header_desktop_items[ 'menu-' . $index ] = $item;

		AAA_Chinese_Builder_Helper::$header_mobile_items[ 'menu-' . $index ] = $item;
	}

	for ( $index = 1; $index <= AAA_Chinese_Builder_Helper::$num_of_header_social_icons; $index++ ) {
		...
		$item = array(
			'name'    => 1 === AAA_Chinese_Builder_Helper::$num_of_header_social_icons ? 'Social' : 'Social ' . $index,
			'icon'    => 'share',
		...
		AAA_Chinese_Builder_Helper::$header_desktop_items[ 'social-icons-' . $index ] = $item;
		AAA_Chinese_Builder_Helper::$header_mobile_items[ 'social-icons-' . $index ]  = $item;
	}
	...
	$_configs = array(
		...
		*/
		 ...
		 */
		array(
			'name'      => AAA_THEME_SETTINGS . '[cloned-component-track]',
			'section'   => 'section-header-builder-layout',
			'type'      => 'control',
			'control'   => 'ast-hidden',
			'priority'  => 43,
			...
			'partial'   => false,
			'default'   => aaa_chinese_get_option( 'cloned-component-track' ),
		),
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[builder-header]',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-desktop-items]',
			'section'     => 'section-header-builder',
			'type'        => 'control',
			'control'     => 'ast-builder',
			'title'       => __( 'Header Builder', 'astra' ),
			'priority'    => 25,
			'default'     => aaa_chinese_get_option( 'header-desktop-items' ),
			'choices'     => AAA_Chinese_Builder_Helper::$header_desktop_items,
			'transport'   => 'refresh',
			'input_attrs' => array(
				'group'  => AAA_THEME_SETTINGS . '[header-desktop-items]',
		...
		array(
			'name'      => AAA_THEME_SETTINGS . '[header-preset-style]',
			'default'   => aaa_chinese_get_option( 'header-preset-style' ),
			'type'      => 'control',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-desktop-draggable-items]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-mobile-items]',
			'section'     => 'section-header-builder',
			'type'        => 'control',
			'control'     => 'ast-builder',
			'title'       => __( 'Header Builder', 'astra' ),
			'priority'    => 35,
			'default'     => aaa_chinese_get_option( 'header-mobile-items' ),
			'choices'     => AAA_Chinese_Builder_Helper::$header_mobile_items,
			'transport'   => 'refresh',
			'input_attrs' => array(
				'group'  => AAA_THEME_SETTINGS . '[header-mobile-items]',
				'rows'   => array( 'popup', 'above', 'primary', 'below' ),
				'zones'  => array(
					'popup'   => array(
						'popup_content' => 'Popup Content',
			...
			'context'     => AAA_Chinese_Builder_Helper::$responsive_devices,
		),
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-mobile-draggable-items]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
			'control'     => 'ast-draggable-items',
			'input_attrs' => array(
		 ...
		 */
		array(
			'name'      => AAA_THEME_SETTINGS . '[header-mobile-popup-items]',
			'section'   => 'section-header-builder-layout',
			'type'      => 'control',
			'control'   => 'ast-hidden',
			'priority'  => 43,
			...
			'partial'   => array(
				...
				'render_callback'     => array( AAA_Chinese_Builder_Header::get_instance(), 'mobile_popup' ),
			),
			'default'   => false,
		),
		 ...
		 */
		array(
			'name'     => AAA_THEME_SETTINGS . '[header-transparent-link-heading]',
			'type'     => 'control',
			'control'  => 'ast-heading',
			'section'  => 'section-header-builder-layout',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-transparant-link]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
		...
		// Option: Header Width.
		array(
			'name'       => AAA_THEME_SETTINGS . '[hb-header-main-layout-width]',
			'default'    => aaa_chinese_get_option( 'hb-header-main-layout-width' ),
			'type'       => 'control',
		...
		array(
			'name'              => AAA_THEME_SETTINGS . '[section-header-builder-layout-margin]',
			'default'           => aaa_chinese_get_option( 'section-header-builder-layout-margin' ),
			'type'              => 'control',
			'transport'         => 'postMessage',
	...
	if ( aaa_chinese_showcase_upgrade_notices() ) {
		 ...
		 */
		$_configs[] = array(
			'name'      => AAA_THEME_SETTINGS . '[header-builder-pro-items]',
			'type'      => 'control',
			'control'   => 'ast-upgrade',
			...
			'divider'   => array( 'ast_class' => 'ast-top-section-divider' ),
			'thumbnail' => AAA_THEME_URI . 'inc/assets/images/customizer/header-builder.png',
		);
	}
	...
	if ( defined( 'AAA_EXT_VER' ) && AAA_Chinese_Ext_Extension::is_active( 'sticky-header' ) ) {
		 ...
		 */
		$_configs[] = array(
			'name'        => AAA_THEME_SETTINGS . '[header-sticky-link]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
			'control'     => 'ast-header-type-button',
			'input_attrs' => array(
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_header_header_builder_configuration', 10, 0 );
}
