 ...
 */
function aaa_chinese_header_site_identity_configuration() {
	...
	$_configs = array(
		 ...
		 */
		array(
			'name'           => AAA_THEME_SETTINGS . '[logo-title-settings-link]',
			'type'           => 'control',
		 ...
		 */
		array(
			'name'        => AAA_THEME_SETTINGS . '[header-logo-color]',
			'default'     => aaa_chinese_get_option( 'header-logo-color' ),
			'type'        => 'control',
			'control'     => 'ast-color',
	...
	if ( defined( 'AAA_EXT_VER' ) && AAA_Chinese_Ext_Extension::is_active( 'typography' ) ) {
		...
		$_configs[] = array(
			...
			'type'              => 'sub-control',
			'parent'            => AAA_THEME_SETTINGS . '[site-title-typography]',
			'section'           => 'title_tagline',
			'control'           => 'ast-responsive-slider',
			'default'           => aaa_chinese_get_option( 'font-size-site-title' ),
			'transport'         => 'postMessage',
			'priority'          => 12,
		...
		$_configs[] = array(
			...
			'type'              => 'sub-control',
			'parent'            => AAA_THEME_SETTINGS . '[site-tagline-typography]',
			'section'           => 'title_tagline',
			'control'           => 'ast-responsive-slider',
			'default'           => aaa_chinese_get_option( 'font-size-site-tagline' ),
			'transport'         => 'postMessage',
			'priority'          => 16,
			'title'             => __( 'Font Size', 'astra' ),
			'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_responsive_slider' ),
		...
		$_configs[] = array(
			'name'              => AAA_THEME_SETTINGS . '[font-size-site-title]',
			'type'              => 'control',
			'section'           => 'title_tagline',
			'default'           => aaa_chinese_get_option( 'font-size-site-title' ),
			'transport'         => 'postMessage',
			...
			'context'           => true === AAA_Chinese_Builder_Helper::$is_header_footer_builder_active ? array(
				AAA_Chinese_Builder_Helper::$design_tab_config,
				array(
					'relation' => 'OR',
					array(
						'setting'     => AAA_THEME_SETTINGS . '[display-site-title-responsive]',
						'setting-key' => 'desktop',
						'operator'    => '==',
						'value'       => true,
					),
		...
		$_configs[] = array(
			'name'              => AAA_THEME_SETTINGS . '[font-size-site-tagline]',
			'type'              => 'control',
			'section'           => 'title_tagline',
			'control'           => 'ast-responsive-slider',
			'default'           => aaa_chinese_get_option( 'font-size-site-tagline' ),
			'transport'         => 'postMessage',
			'priority'          => true === AAA_Chinese_Builder_Helper::$is_header_footer_builder_active ? 20 : 12,
			...
			'context'           => true === AAA_Chinese_Builder_Helper::$is_header_footer_builder_active ? array(
				...
				array(
					'relation' => 'OR',
					array(
						'setting'     => AAA_THEME_SETTINGS . '[display-site-tagline-responsive]',
						'setting-key' => 'desktop',
						'operator'    => '==',
						'value'       => true,
					),
...
if ( AAA_Chinese_Builder_Customizer::aaa_chinese_collect_customizer_builder_data() ) {
	add_action( 'init', 'aaa_chinese_header_site_identity_configuration' );
}
