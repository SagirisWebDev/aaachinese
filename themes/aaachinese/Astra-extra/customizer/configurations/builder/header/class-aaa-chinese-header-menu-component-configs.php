...
if ( class_exists( 'AAA_Chinese_Customizer_Config_Base' ) ) {
	 ...
	 * @since 3.0.0
	 */
	class AAA_Chinese_Header_Menu_Component_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register Builder Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			$menu_config = aaa_chinese_header_menu_configuration();
	 ...
	 */
	new AAA_Chinese_Header_Menu_Component_Configs();
}
