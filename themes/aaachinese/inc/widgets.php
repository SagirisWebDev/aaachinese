 ...
 */
if ( ! function_exists( 'aaa_chinese_widget_tag_cloud_args' ) ) {
	 ...
	 */
	function aaa_chinese_widget_tag_cloud_args( $args = array() ) {
		...
		return apply_filters( 'aaa_chinese_widget_tag_cloud_args', $args );
	}
	add_filter( 'widget_tag_cloud_args', 'aaa_chinese_widget_tag_cloud_args', 90 );
 ...
 */
if ( ! function_exists( 'aaa_chinese_filter_widget_tag_cloud' ) ) {
	 ...
	 */
	function aaa_chinese_filter_widget_tag_cloud( $tags_data ) {
		...
		return apply_filters( 'aaa_chinese_filter_widget_tag_cloud', $tags_data );
	}
	add_filter( 'wp_generate_tag_cloud_data', 'aaa_chinese_filter_widget_tag_cloud' );
 ...
 */
if ( ! function_exists( 'aaa_chinese_widgets_init' ) ) {
	 ...
	 */
	function aaa_chinese_widgets_init() {
		 ...
		 */
		if ( class_exists( 'AAA_Chinese_Builder_Helper' ) && false === AAA_Chinese_Builder_Helper::$is_header_footer_builder_active ) {
			register_sidebar(
				apply_filters(
					'aaa_chinese_header_widgets_init',
					array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_footer_1_widgets_init',
				array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_footer_2_widgets_init',
				array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_advanced_footer_widget_1_args',
				array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_advanced_footer_widget_2_args',
				array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_advanced_footer_widget_3_args',
				array(
		...
		register_sidebar(
			apply_filters(
				'aaa_chinese_advanced_footer_widget_4_args',
				array(
	...
	add_action( 'widgets_init', 'aaa_chinese_widgets_init' );
