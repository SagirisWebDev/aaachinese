 ...
 *
 * @package AAA Chinese WordPress theme
 */
if ( ! class_exists( 'AAA_Chinese_Walker_Page' ) ) {

	/**
	 * AAA Chinese custom navigation walker.
	 *
	 * @since 1.0.0
	 */
	class AAA_Chinese_Walker_Page extends Walker_Page {
		/**
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output  = apply_filters( 'aaa_chinese_caret_wrap_filter', $output, $args['sort_column'] );
		}
			...
			if ( isset( $args['pages_with_children'][ $page->ID ] ) ) {
				...
				if ( true === is_object( $args ) ) {
					...
					'below_header_menu' === $args->theme_location )
						...
						$mobile_icon = '<button ' . aaa_chinese_attr(
							'ast-menu-toggle',
							array(
								'aria-expanded' => 'false',
								'aria-haspopup' => 'true',
