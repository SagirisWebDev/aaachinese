 ...
 */
class AAA_Chinese_WP_Editor_CSS {
	/**
	 * AAA Chinese block editor block editor - padding preset CSS.
	 *
	 * @return array Devices specific padding spacings.
	 *
	 * @since 1.0.0
	 */
	public static function aaa_chinese_get_block_spacings() {
		$wp_block_spacing_type     = aaa_chinese_get_option( 'wp-blocks-ui' );
		$container_blocks_spacings = aaa_chinese_get_option( 'wp-blocks-global-padding' );
		switch ( $wp_block_spacing_type ) {
			...
			case 'comfort':
				...
				break;
			case 'custom':
				$desktop_top_block_space    = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'top', 'desktop' );
				$desktop_right_block_space  = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'right', 'desktop' );
				$desktop_bottom_block_space = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'bottom', 'desktop' );
				$desktop_left_block_space   = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'left', 'desktop' );
				$tablet_top_block_space     = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'top', 'tablet' );
				$tablet_right_block_space   = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'right', 'tablet' );
				$tablet_bottom_block_space  = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'bottom', 'tablet' );
				$tablet_left_block_space    = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'left', 'tablet' );
				$mobile_top_block_space     = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'top', 'mobile' );
				$mobile_right_block_space   = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'right', 'mobile' );
				$mobile_bottom_block_space  = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'bottom', 'mobile' );
				$mobile_left_block_space    = aaa_chinese_responsive_spacing( $container_blocks_spacings, 'left', 'mobile' );
				break;
			default:
	...
	public static function get_css() {
		...
		$headings_font_family    = aaa_chinese_get_option( 'headings-font-family' );
		$headings_font_weight    = aaa_chinese_get_option( 'headings-font-weight' );
		$headings_text_transform = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'headings-font-extras' ), 'text-transform' );
		$headings_line_height    = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'headings-font-extras' ), 'line-height', 'line-height-unit' );
		$body_font_family        = aaa_chinese_body_font_family();
		$para_margin_bottom      = aaa_chinese_get_option( 'para-margin-bottom', '1.6' );
		$theme_color             = aaa_chinese_get_option( 'theme-color' );
		$heading_base_color      = aaa_chinese_get_option( 'heading-base-color' );

		$highlight_theme_color = aaa_chinese_get_foreground_color( $theme_color );

		$body_font_weight     = aaa_chinese_get_option( 'body-font-weight' );
		$body_font_size       = aaa_chinese_get_option( 'font-size-body' );
		$body_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'body-font-extras' ), 'line-height', 'line-height-unit' );
		$body_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'body-font-extras' ), 'text-transform' );
		$body_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'body-font-extras' ), 'letter-spacing', 'letter-spacing-unit' );
		$body_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'body-font-extras' ), 'text-decoration' );
		$text_color           = aaa_chinese_get_option( 'text-color' );

		$heading_h1_font_size = aaa_chinese_get_option( 'font-size-h1' );
		$heading_h2_font_size = aaa_chinese_get_option( 'font-size-h2' );
		$heading_h3_font_size = aaa_chinese_get_option( 'font-size-h3' );
		$heading_h4_font_size = aaa_chinese_get_option( 'font-size-h4' );
		$heading_h5_font_size = aaa_chinese_get_option( 'font-size-h5' );
		$heading_h6_font_size = aaa_chinese_get_option( 'font-size-h6' );
		...
		$btn_border_size           = aaa_chinese_get_option( 'theme-button-border-group-border-size' );
		...
		$theme_btn_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-button' ), 'text-transform' );
		$theme_btn_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-button' ), 'line-height', 'line-height-unit' );
		$theme_btn_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
		$theme_btn_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-button' ), 'text-decoration' );
		$theme_btn_top_border      = isset( $btn_border_size['top'] ) && ( '' !== $btn_border_size['top'] && '0' !== $btn_border_size['top'] ) ? aaa_chinese_get_css_value( $btn_border_size['top'], 'px' ) : '';
		$theme_btn_right_border    = isset( $btn_border_size['right'] ) && ( '' !== $btn_border_size['right'] && '0' !== $btn_border_size['right'] ) ? aaa_chinese_get_css_value( $btn_border_size['right'], 'px' ) : '';
		$theme_btn_left_border     = isset( $btn_border_size['left'] ) && ( '' !== $btn_border_size['left'] && '0' !== $btn_border_size['left'] ) ? aaa_chinese_get_css_value( $btn_border_size['left'], 'px' ) : '';
		$theme_btn_bottom_border   = isset( $btn_border_size['bottom'] ) && ( '' !== $btn_border_size['bottom'] && '0' !== $btn_border_size['bottom'] ) ? aaa_chinese_get_css_value( $btn_border_size['bottom'], 'px' ) : '';

		/**
		 * Headings typography.
		 */
		$h1_font_family     = aaa_chinese_get_option( 'font-family-h1' );
		$h1_font_weight     = aaa_chinese_get_option( 'font-weight-h1' );
		$h1_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h1' ), 'line-height', 'line-height-unit' );
		$h1_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h1' ), 'text-transform' );
		$h1_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h1' ), 'letter-spacing', 'letter-spacing-unit' );
		$h1_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h1' ), 'text-decoration' );

		$h2_font_family     = aaa_chinese_get_option( 'font-family-h2' );
		$h2_font_weight     = aaa_chinese_get_option( 'font-weight-h2' );
		$h2_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h2' ), 'line-height', 'line-height-unit' );
		$h2_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h2' ), 'text-transform' );
		$h2_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h2' ), 'letter-spacing', 'letter-spacing-unit' );
		$h2_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h2' ), 'text-decoration' );

		$h3_font_family     = aaa_chinese_get_option( 'font-family-h3' );
		$h3_font_weight     = aaa_chinese_get_option( 'font-weight-h3' );
		$h3_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h3' ), 'line-height', 'line-height-unit' );
		$h3_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h3' ), 'text-transform' );
		$h3_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h3' ), 'letter-spacing', 'letter-spacing-unit' );
		$h3_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h3' ), 'text-decoration' );

		$h4_font_family     = aaa_chinese_get_option( 'font-family-h4' );
		$h4_font_weight     = aaa_chinese_get_option( 'font-weight-h4' );
		$h4_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h4' ), 'line-height', 'line-height-unit' );
		$h4_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h4' ), 'text-transform' );
		$h4_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h4' ), 'letter-spacing', 'letter-spacing-unit' );
		$h4_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h4' ), 'text-decoration' );

		$h5_font_family     = aaa_chinese_get_option( 'font-family-h5' );
		$h5_font_weight     = aaa_chinese_get_option( 'font-weight-h5' );
		$h5_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h5' ), 'line-height', 'line-height-unit' );
		$h5_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h5' ), 'text-transform' );
		$h5_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h5' ), 'letter-spacing', 'letter-spacing-unit' );
		$h5_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h5' ), 'text-decoration' );

		$h6_font_family     = aaa_chinese_get_option( 'font-family-h6' );
		$h6_font_weight     = aaa_chinese_get_option( 'font-weight-h6' );
		$h6_line_height     = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h6' ), 'line-height', 'line-height-unit' );
		$h6_text_transform  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h6' ), 'text-transform' );
		$h6_letter_spacing  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h6' ), 'letter-spacing', 'letter-spacing-unit' );
		$h6_text_decoration = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'font-extras-h6' ), 'text-decoration' );
		...
		$site_background       = aaa_chinese_get_option( 'site-layout-outside-bg-obj-responsive' );
		$content_background    = aaa_chinese_get_option( 'content-bg-obj-responsive' );
		$background_style_data = aaa_chinese_get_responsive_background_obj( $site_background, 'desktop' );
		if (
		...
		$site_title_font_family              = aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-family', aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-text-font-family' ) );
		$site_title_font_weight              = aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-weight', AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'title-font-weight' ) );
		$site_title_font_size                = aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-size', AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'title-font-size' ) );
		$site_title_font_extras              = aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-text-font-extras' );
		$site_title_text_transform           = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'text-transform' );
		$site_title_spacing                  = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'letter-spacing', 'letter-spacing-unit' );
		$site_title_decoration               = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'text-decoration' );
		$is_widget_title_support_font_weight = AAA_Chinese_Dynamic_CSS::support_font_css_to_widget_and_in_editor();
		$font_weight_prop                    = $is_widget_title_support_font_weight ? 'inherit' : 'normal';
		$btn_preset_style                    = aaa_chinese_get_option( 'button-preset-style' );
		$border_color                        = aaa_chinese_get_option( 'border-color' );
		...
		if ( '' == $site_title_text_transform ) {
			$site_title_text_transform = '' === $headings_text_transform ? aaa_chinese_get_option( 'text-transform-h1' ) : $headings_text_transform;
		}
		if ( 'inherit' === $site_title_font_weight || '' == $site_title_font_weight ) {
			$site_title_font_weight = AAA_Chinese_Posts_Structure_Loader::get_customizer_default( 'title-font-weight' );
		}
		...
		$aaa_chinese_is_block_editor_v2_ui = aaa_chinese_get_option( 'wp-blocks-v2-ui', true );
		$aaa_chinese_container_width       = $site_content_width . 'px';
		$block_appender_width        = $aaa_chinese_is_block_editor_v2_ui ? 'var(--wp--custom--ast-content-width-size)' : 'var(--wp--custom--ast-wide-width-size)';

		$aaa_chinese_wide_particular_selector = $aaa_chinese_is_block_editor_v2_ui ? '.editor-styles-wrapper .block-editor-block-list__layout.is-root-container .block-list-appender' : '.editor-styles-wrapper .block-editor-block-list__layout.is-root-container > p, .editor-styles-wrapper .block-editor-block-list__layout.is-root-container .block-list-appender';

		$blocks_spacings          = self::aaa_chinese_get_block_spacings();
		$color_palette_reorganize = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_8_9_compatibility();
		...
		$ast_content_width = apply_filters( 'aaa_chinese_block_content_width', $aaa_chinese_is_block_editor_v2_ui ? $aaa_chinese_container_width : '910px' );
		$ast_wide_width    = apply_filters( 'aaa_chinese_block_wide_width', $aaa_chinese_is_block_editor_v2_ui ? 'calc(' . esc_attr( $aaa_chinese_container_width ) . ' + var(--wp--custom--ast-default-block-left-padding) + var(--wp--custom--ast-default-block-right-padding))' : $aaa_chinese_container_width );
		$ast_narrow_width  = aaa_chinese_get_option( 'narrow-container-max-width', apply_filters( 'aaa_chinese_narrow_container_width', 750 ) ) . 'px';
		...
		$html_font_size = aaa_chinese_get_font_css_value( (int) $body_font_size_desktop * 6.25, '%' );
		/** @psalm-suppress InvalidScalarArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		...
		$btn_border_color   = aaa_chinese_get_option( 'theme-button-border-group-border-color' );
		$btn_border_h_color = aaa_chinese_get_option( 'theme-button-border-group-border-h-color' );
		$link_hover_color   = aaa_chinese_get_option( 'link-h-color' );
		$btn_bg_hover_color = aaa_chinese_get_option( 'button-bg-h-color', $link_hover_color );
		...
		if ( 'button_04' === $btn_preset_style || 'button_05' === $btn_preset_style || 'button_06' === $btn_preset_style ) {
			...
			if ( '' === aaa_chinese_get_option( 'button-bg-color' ) && '' === aaa_chinese_get_option( 'button-color' ) ) {
				$btn_color = $theme_color;
			} elseif ( '' === aaa_chinese_get_option( 'button-color' ) ) {
		 ...
		 */
		$btn_text_hover_color = aaa_chinese_get_option( 'button-h-color' );
		if ( empty( $btn_text_hover_color ) ) {
			$btn_text_hover_color = aaa_chinese_get_foreground_color( $link_hover_color );
		}

		$desktop_css = array(
			':root'                            => AAA_Chinese_Global_Palette::generate_global_palette_style(),
			'html'                             => array(
				'font-size' => $html_font_size,
			),
			$aaa_chinese_wide_particular_selector    => array(
			...
			'.editor-styles-wrapper'           => aaa_chinese_get_responsive_background_obj( $content_background, 'desktop' ),

			'.editor-styles-wrapper, #customize-controls .editor-styles-wrapper' => array(
				'font-family'     => aaa_chinese_get_font_family( $body_font_family ),
				'font-weight'     => esc_attr( $body_font_weight ),
				'font-size'       => aaa_chinese_responsive_font( $body_font_size, 'desktop' ),
				'line-height'     => esc_attr( $body_line_height ),
				'text-transform'  => esc_attr( $body_text_transform ),
				'text-decoration' => esc_attr( $body_text_decoration ),
				'letter-spacing'  => esc_attr( $body_letter_spacing ),
			),
			'.editor-styles-wrapper h1, .editor-styles-wrapper h2, .editor-styles-wrapper h3, .editor-styles-wrapper h4, .editor-styles-wrapper h5, .editor-styles-wrapper h6' => aaa_chinese_get_font_array_css( aaa_chinese_get_option( 'headings-font-family' ), aaa_chinese_get_option( 'headings-font-weight' ), array(), 'headings-font-extras', $heading_base_color ),

			".wp-block-cover:not([class*='background-color']):not(.has-text-color.has-link-color):not(.wp-block-cover__inner-container .wp-block-cover ). block-editor-block-list__block" => aaa_chinese_get_font_array_css( aaa_chinese_get_option( 'headings-font-family' ), aaa_chinese_get_option( 'headings-font-weight' ), array(), 'headings-font-extras', $heading_base_color ),

			// Headings H1 - H6 typography.
			'.editor-styles-wrapper h1'        => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h1_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h1_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h1_font_weight, 'font' ),
			...
			'.editor-styles-wrapper h2'        => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h2_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h2_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h2_font_weight, 'font' ),
			...
			'.editor-styles-wrapper h3, #customize-controls .editor-styles-wrapper h3' => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h3_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h3_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h3_font_weight, 'font' ),
			...
			'.editor-styles-wrapper h4'        => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h4_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h4_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h4_font_weight, 'font' ),
			...
			'.editor-styles-wrapper h5'        => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h5_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h5_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h5_font_weight, 'font' ),
			...
			'.editor-styles-wrapper h6'        => array(
				'font-size'       => aaa_chinese_responsive_font( $heading_h6_font_size, 'desktop' ),
				'font-family'     => aaa_chinese_get_css_value( $h6_font_family, 'font' ),
				'font-weight'     => aaa_chinese_get_css_value( $h6_font_weight, 'font' ),
			...
			'.editor-styles-wrapper .block-editor-block-list__layout.is-root-container p' => array(
				'margin-bottom' => aaa_chinese_get_css_value( $para_margin_bottom, 'em' ),
			),
			...
			':where(.editor-styles-wrapper .wp-block-button:not(.is-style-outline)) :is(div, button).wp-block-button__link, .block-editor-writing-flow .wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button, .block-editor-writing-flow .wp-block-file .wp-block-file__button, .editor-styles-wrapper button.wc-block-components-button' => array(
				...
				'font-family'                => aaa_chinese_get_font_family( $theme_btn_font_family ),
				...
				'letter-spacing'             => aaa_chinese_get_css_value( $theme_btn_letter_spacing, 'px' ),
				'text-decoration'            => esc_attr( $theme_btn_text_decoration ),
				'font-size'                  => aaa_chinese_responsive_font( $theme_btn_font_size, 'desktop' ),
		...
		if ( 'post' === $post_type && apply_filters( 'aaa_chinese_improvise_single_post_design', AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_0_compatibility() ) ) {
		...
		if ( AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_0_compatibility() && aaa_chinese_get_option( 'single-content-images-shadow', false ) ) {
			...
			$desktop_css[ 'button, .ast-button, .button, input[type="button"], input[type="reset"], input[type="submit"]' . ( aaa_chinese_button_consistency_compatibility() ? ', .wp-block-button__link' : '' ) ] = array(
				'border-radius' => '4px',
			);
		}
		...
		if ( defined( 'AAA_EXT_VER' ) ) {
			...
			$h1_color = aaa_chinese_get_option( 'h1-color' );
			$h2_color = aaa_chinese_get_option( 'h2-color' );
			$h3_color = aaa_chinese_get_option( 'h3-color' );
			$h4_color = aaa_chinese_get_option( 'h4-color' );
			$h5_color = aaa_chinese_get_option( 'h5-color' );
			$h6_color = aaa_chinese_get_option( 'h6-color' );
		...
		if ( AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_4_compatibility() ) {
		...
		$desktop_css['.editor-styles-wrapper .edit-post-visual-editor__post-title-wrapper > h1'] = array(
			'font-size'       => aaa_chinese_responsive_font( $site_title_font_size, 'desktop' ),
			'font-weight'     => aaa_chinese_get_css_value( $site_title_font_weight, 'font' ),
			'font-family'     => aaa_chinese_get_css_value( $site_title_font_family, 'font', $body_font_family ),
		...
		if ( aaa_chinese_button_default_padding_updated() ) {
			$default_border_size = '';
		}

		// Secondary button editor compatibility.
		$scndry_btn_text_color                   = aaa_chinese_get_option( 'secondary-button-color' );
		$scndry_btn_border_color                 = aaa_chinese_get_option( 'secondary-theme-button-border-group-border-color' );
		$scndry_btn_border_h_color               = aaa_chinese_get_option( 'secondary-theme-button-border-group-border-h-color' );
		$global_scndry_custom_button_border_size = aaa_chinese_get_option( 'secondary-theme-button-border-group-border-size' );
		$scndry_theme_btn_top_border             = isset( $global_scndry_custom_button_border_size['top'] ) && ( '' !== $global_scndry_custom_button_border_size['top'] && '0' !== $global_scndry_custom_button_border_size['top'] ) ? aaa_chinese_get_css_value( $global_scndry_custom_button_border_size['top'], 'px' ) : $default_border_size;
		$scndry_theme_btn_right_border           = isset( $global_scndry_custom_button_border_size['right'] ) && ( '' !== $global_scndry_custom_button_border_size['right'] && '0' !== $global_scndry_custom_button_border_size['right'] ) ? aaa_chinese_get_css_value( $global_scndry_custom_button_border_size['right'], 'px' ) : $default_border_size;
		$scndry_theme_btn_left_border            = isset( $global_scndry_custom_button_border_size['left'] ) && ( '' !== $global_scndry_custom_button_border_size['left'] && '0' !== $global_scndry_custom_button_border_size['left'] ) ? aaa_chinese_get_css_value( $global_scndry_custom_button_border_size['left'], 'px' ) : $default_border_size;
		$scndry_theme_btn_bottom_border          = isset( $global_scndry_custom_button_border_size['bottom'] ) && ( '' !== $global_scndry_custom_button_border_size['bottom'] && '0' !== $global_scndry_custom_button_border_size['bottom'] ) ? aaa_chinese_get_css_value( $global_scndry_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
		$scndry_theme_btn_font_family            = aaa_chinese_get_option( 'secondary-font-family-button' );
		$scndry_theme_btn_font_size              = aaa_chinese_get_option( 'secondary-font-size-button' );
		$scndry_theme_btn_font_weight            = aaa_chinese_get_option( 'secondary-font-weight-button' );
		$scndry_theme_btn_text_transform         = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'secondary-font-extras-button' ), 'text-transform' );
		$scndry_theme_btn_line_height            = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'secondary-font-extras-button' ), 'line-height', 'line-height-unit' );
		$scndry_theme_btn_letter_spacing         = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'secondary-font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
		$scndry_theme_btn_text_decoration        = aaa_chinese_get_font_extras( aaa_chinese_get_option( 'secondary-font-extras-button' ), 'text-decoration' );
		$scndry_theme_btn_padding                = aaa_chinese_get_option( 'secondary-theme-button-padding' );
		$scndry_btn_border_radius_fields         = aaa_chinese_get_option( 'secondary-button-radius-fields' );
		$scndry_btn_bg_color                     = aaa_chinese_get_option( 'secondary-button-bg-color' );
		$scndry_btn_bg_hover_color               = aaa_chinese_get_option( 'secondary-button-bg-h-color' );
		$scndry_btn_text_hover_color             = aaa_chinese_get_option( 'secondary-button-h-color' );
		$scndry_btn_border_radius_top            = aaa_chinese_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'desktop' );
		$scndry_btn_border_radius_right          = aaa_chinese_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'desktop' );
		$scndry_btn_border_radius_bottom         = aaa_chinese_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'desktop' );
		$scndry_btn_border_radius_left           = aaa_chinese_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'desktop' );
		...
		if ( empty( $scndry_btn_border_radius_top ) && empty( $scndry_btn_border_radius_right ) && empty( $scndry_btn_border_radius_bottom ) && empty( $scndry_btn_border_radius_left ) ) {
			$scndry_btn_border_radius_top    = aaa_chinese_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' );
			$scndry_btn_border_radius_right  = aaa_chinese_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' );
			$scndry_btn_border_radius_bottom = aaa_chinese_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' );
			$scndry_btn_border_radius_left   = aaa_chinese_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' );
		}

		// Secondary button preset compatibility.
		$secondary_btn_preset_style = aaa_chinese_get_option( 'secondary-button-preset-style' );
		...
		if ( 'button_04' === $secondary_btn_preset_style || 'button_05' === $secondary_btn_preset_style || 'button_06' === $secondary_btn_preset_style ) {
			...
			if ( '' === aaa_chinese_get_option( 'secondary-button-bg-color' ) && '' === aaa_chinese_get_option( 'secondary-button-color' ) ) {
				$btn_color_val = $theme_color;
			} elseif ( '' === aaa_chinese_get_option( 'secondary-button-color' ) ) {
		...
		$secondary_btn_desktop_font_size = is_array( $scndry_theme_btn_font_size ) && isset( $scndry_theme_btn_font_size['desktop'] ) && isset( $scndry_theme_btn_font_size['desktop-unit'] ) ? aaa_chinese_get_font_css_value( $scndry_theme_btn_font_size['desktop'], $scndry_theme_btn_font_size['desktop-unit'] ) : '';
		/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		...
		$outline_button_css_desktop = array(
			'.editor-styles-wrapper .wp-block-buttons .wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button' => array(
				...
				'font-family'                => aaa_chinese_get_font_family( $scndry_theme_btn_font_family ),
				...
				'padding-top'                => aaa_chinese_responsive_spacing( $scndry_theme_btn_padding, 'top', 'desktop' ),
				'padding-right'              => aaa_chinese_responsive_spacing( $scndry_theme_btn_padding, 'right', 'desktop' ),
				'padding-bottom'             => aaa_chinese_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'desktop' ),
				'padding-left'               => aaa_chinese_responsive_spacing( $scndry_theme_btn_padding, 'left', 'desktop' ),
		...
		if ( 'button_01' === $secondary_btn_preset_style || 'button_02' === $secondary_btn_preset_style || 'button_03' === $secondary_btn_preset_style ) {
			if ( empty( $scndry_btn_text_color ) ) {
				$scndry_btn_text_color = aaa_chinese_get_foreground_color( $theme_color );
			}
		...
		$content_links_underline = aaa_chinese_get_option( 'underline-content-links' );
		...
		if ( $aaa_chinese_is_block_editor_v2_ui ) {
			$single_post_continer_spacing = aaa_chinese_get_option( 'single-post-inside-spacing' );
			$aaa_chinese_continer_left_spacing  = defined( 'AAA_EXT_VER' ) && aaa_chinese_responsive_spacing( $single_post_continer_spacing, 'left', 'desktop' ) ? aaa_chinese_responsive_spacing( $single_post_continer_spacing, 'left', 'desktop' ) : '6.67em';
			$aaa_chinese_continer_right_spacing = defined( 'AAA_EXT_VER' ) && aaa_chinese_responsive_spacing( $single_post_continer_spacing, 'right', 'desktop', '6.67' ) ? aaa_chinese_responsive_spacing( $single_post_continer_spacing, 'right', 'desktop', '6.67' ) : '6.67em';

			$alignwide_left_negative_margin  = $aaa_chinese_continer_left_spacing ? 'calc(-1 * min(' . $aaa_chinese_continer_left_spacing . ', 40px))' : '-40px';
			$alignwide_right_negative_margin = $aaa_chinese_continer_right_spacing ? 'calc(-1 * min(' . $aaa_chinese_continer_right_spacing . ', 40px))' : '-40px';
			$heading_width_comp              = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_8_0_compatibility() ? 'none' : 'var(--wp--custom--ast-content-width-size)';
			$container_width_comp            = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_8_4_compatibility() ? 'var(--wp--custom--ast-content-width-size)' : '';
		...
		$tablet_css = array(
			...
			'.editor-styles-wrapper h1'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h1_font_size, 'tablet', '30' ),
			),
			'.editor-styles-wrapper h2'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h2_font_size, 'tablet', '25' ),
			),
			'.editor-styles-wrapper h3'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h3_font_size, 'tablet', '20' ),
			),
			'.editor-styles-wrapper h4'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h4_font_size, 'tablet' ),
			),
			'.editor-styles-wrapper h5'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h5_font_size, 'tablet' ),
			),
			'.editor-styles-wrapper h6'                    => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h6_font_size, 'tablet' ),
			),
			'.edit-post-visual-editor__post-title-wrapper' => array(
				'margin-top' => '0',
			),
			'#editor .edit-post-visual-editor'             => aaa_chinese_get_responsive_background_obj( $site_background, 'tablet' ),
			'.editor-styles-wrapper'                       => aaa_chinese_get_responsive_background_obj( $content_background, 'tablet' ),
		);
		...
		$tablet_css['.editor-styles-wrapper .edit-post-visual-editor__post-title-wrapper > h1'] = array(
			'font-size' => aaa_chinese_responsive_font( $site_title_font_size, 'tablet' ),
		);
		...
		$mobile_css = array(
			...
			// Heading H1 - H6 font size.
			'.editor-styles-wrapper h1'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h1_font_size, 'mobile', '30' ),
			),
			'.editor-styles-wrapper h2'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h2_font_size, 'mobile', '25' ),
			),
			'.editor-styles-wrapper h3'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h3_font_size, 'mobile', '20' ),
			),
			'.editor-styles-wrapper h4'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h4_font_size, 'mobile' ),
			),
			'.editor-styles-wrapper h5'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h5_font_size, 'mobile' ),
			),
			'.editor-styles-wrapper h6'          => array(
				'font-size' => aaa_chinese_responsive_font( $heading_h6_font_size, 'mobile' ),
			),
			'#editor .edit-post-visual-editor'   => aaa_chinese_get_responsive_background_obj( $site_background, 'mobile' ),
			'.editor-styles-wrapper'             => aaa_chinese_get_responsive_background_obj( $content_background, 'mobile' ),
		);
		...
		$mobile_css['.editor-styles-wrapper .edit-post-visual-editor__post-title-wrapper > h1'] = array(
			'font-size' => aaa_chinese_responsive_font( $site_title_font_size, 'mobile' ),
		);
		...
		$css .= aaa_chinese_parse_css( $desktop_css );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$css .= aaa_chinese_parse_css( $tablet_css, '', aaa_chinese_get_tablet_breakpoint() );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$css .= aaa_chinese_parse_css( $mobile_css, '', aaa_chinese_get_mobile_breakpoint() );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
