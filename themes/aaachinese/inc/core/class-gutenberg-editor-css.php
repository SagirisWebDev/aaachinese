...
if ( ! class_exists( 'Gutenberg_Editor_CSS' ) ) {
	...
	class Gutenberg_Editor_CSS {
		...
		public static function get_css() {
			...
			$site_content_width      = aaa_chinese_get_option( 'site-content-width', 1200 ) + 56;
			...
			$para_margin_bottom      = aaa_chinese_get_option( 'para-margin-bottom' );
			...
			$body_line_height    = aaa_chinese_get_option( 'body-line-height' );
			$body_text_transform = aaa_chinese_get_option( 'body-text-transform' );
			$box_bg_obj          = aaa_chinese_get_option( 'site-layout-outside-bg-obj-responsive' );
			...
			$single_post_title       = aaa_chinese_get_option( 'ast-dynamic-single-post-structure', array( 'ast-dynamic-single-post-title', 'ast-dynamic-single-post-meta' ) );
			...
			$site_title_font_family    = aaa_chinese_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-family' );
			$site_title_font_weight    = aaa_chinese_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-weight' );
			$site_title_line_height    = aaa_chinese_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-line-height' );
			$site_title_font_size      = aaa_chinese_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-size' );
			$site_title_text_transform = aaa_chinese_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-text-transform', $headings_text_transform );
			...
			$improve_gb_ui = aaa_chinese_get_option( 'improve-gb-editor-ui', true );
			/** @psalm-suppress InvalidScalarArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

			$ast_content_width = apply_filters( 'aaa_chinese_block_content_width', '910px' );
			...
			$aaa_chinese_apply_content_background = aaa_chinese_apply_content_background_fullwidth_layouts();

			$desktop_css = array(
				'html'                                    => array(
					'font-size' => aaa_chinese_get_font_css_value( (int) $body_font_size_desktop * 6.25, '%' ),
				),
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'desktop' ),
				'.editor-post-title__block .editor-post-title__input,  .edit-post-visual-editor .block-editor-block-list__block h1, .edit-post-visual-editor .block-editor-block-list__block h2, .edit-post-visual-editor .block-editor-block-list__block h3, .edit-post-visual-editor .block-editor-block-list__block h4, .edit-post-visual-editor .block-editor-block-list__block h5, .edit-post-visual-editor .block-editor-block-list__block h6, .edit-post-visual-editor h1, .edit-post-visual-editor h2, .edit-post-visual-editor h3, .edit-post-visual-editor h4, .edit-post-visual-editor h5, .edit-post-visual-editor h6' => array(
					'font-family'    => aaa_chinese_get_css_value( $headings_font_family, 'font' ),
					'font-weight'    => aaa_chinese_get_css_value( $headings_font_weight, 'font' ),
				...
				'.editor-post-title__block .editor-post-title__input' => array(
					'font-family' => 'inherit' === $headings_font_family ? aaa_chinese_get_font_family( $body_font_family ) : aaa_chinese_get_font_family( $headings_font_family ),
					'font-weight' => 'normal',
				),
				...
				'blockquote'                              => array(
					'color' => aaa_chinese_adjust_brightness( $text_color, 75, 'darken' ),
				),
				'blockquote .editor-rich-text__tinymce a' => array(
					'color' => aaa_chinese_hex_to_rgba( $link_color, 1 ),
				),
				'blockquote'                              => array(
					'border-color' => aaa_chinese_hex_to_rgba( $link_color, 0.05 ),
				),
				'.block-editor-block-list__block .wp-block-quote:not(.is-large):not(.is-style-large), .edit-post-visual-editor .wp-block-pullquote blockquote' => array(
					'border-color' => aaa_chinese_hex_to_rgba( $link_color, 0.15 ),
				),
			...
			if ( false === $improve_gb_ui ) {
				$desktop_css['.editor-post-title__block,.editor-default-block-appender,.block-editor-block-list__block'] = array(
					'max-width' => aaa_chinese_get_css_value( $site_content_width, 'px' ),
				);
				$desktop_css['.block-editor-block-list__block[data-align=wide]'] = array(
					'max-width' => aaa_chinese_get_css_value( $site_content_width + 200, 'px' ),
				);
			}

			$background_style_data = aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'desktop' );
			...
			if ( aaa_chinese_wp_version_compare( '5.7', '>=' ) ) {
				...
				if ( true === $improve_gb_ui ) {
					...
					$desktop_css['.edit-post-visual-editor .editor-styles-wrapper'] = array(
						'max-width' => aaa_chinese_get_css_value( $site_content_width - 56, 'px' ),
						'width'     => '100%',
						'margin'    => '0 auto',
						'padding'   => '0',
					);
			...
			if ( aaa_chinese_wp_version_compare( '5.8', '>=' ) ) {
				...
				if ( false === $aaa_chinese_apply_content_background ) {
			...
			if ( ( ( ! in_array( 'ast-dynamic-single-post-title', $single_post_title ) ) && ( 'post' === get_post_type() ) ) || ( 'disabled' === $title_enabled_from_meta ) ) {
				...
				$css             .= aaa_chinese_parse_css( $destop_title_css );
			}
			...
			if ( aaa_chinese_wp_version_compare( '5.7', '>=' ) ) {
				$css_prod_button_tablet['.ast-page-builder-template .editor-styles-wrapper .block-editor-writing-flow, .ast-plain-container .editor-styles-wrapper .block-editor-writing-flow'] = aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'tablet' );
			}

			$css .= aaa_chinese_parse_css( $css_prod_button_tablet, '', aaa_chinese_get_tablet_breakpoint() );
			...
			if ( aaa_chinese_wp_version_compare( '5.7', '>=' ) ) {
				$css_prod_button_mobile['.ast-page-builder-template .editor-styles-wrapper .block-editor-writing-flow, .ast-plain-container .editor-styles-wrapper .block-editor-writing-flow'] = aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'mobile' );
			}

			$css .= aaa_chinese_parse_css( $css_prod_button_mobile, '', aaa_chinese_get_mobile_breakpoint() );

			$theme_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? aaa_chinese_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '1px';
			$theme_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? aaa_chinese_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '1px';
			$theme_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? aaa_chinese_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '1px';
			$theme_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? aaa_chinese_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '1px';

			if ( AAA_Chinese_Dynamic_CSS::page_builder_button_style_css() ) {

				$is_support_wp_5_8            = AAA_Chinese_Dynamic_CSS::is_block_editor_support_enabled();
				...
				$css .= aaa_chinese_parse_css( $button_desktop_css );
				...
				$css .= aaa_chinese_parse_css( $css_global_button_tablet, '', aaa_chinese_get_tablet_breakpoint() );
				...
				$css .= aaa_chinese_parse_css( $css_global_button_mobile, '', aaa_chinese_get_mobile_breakpoint() );
			}

			if ( AAA_Chinese_Dynamic_CSS::gutenberg_core_patterns_compat() ) {
				...
				$theme_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && ( '' !== $global_custom_button_border_size['top'] && '0' !== $global_custom_button_border_size['top'] ) ? aaa_chinese_get_css_value( $global_custom_button_border_size['top'], 'px' ) : $default_border_size;
				$theme_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && ( '' !== $global_custom_button_border_size['right'] && '0' !== $global_custom_button_border_size['right'] ) ? aaa_chinese_get_css_value( $global_custom_button_border_size['right'], 'px' ) : $default_border_size;
				$theme_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && ( '' !== $global_custom_button_border_size['left'] && '0' !== $global_custom_button_border_size['left'] ) ? aaa_chinese_get_css_value( $global_custom_button_border_size['left'], 'px' ) : $default_border_size;
				$theme_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && ( '' !== $global_custom_button_border_size['bottom'] && '0' !== $global_custom_button_border_size['bottom'] ) ? aaa_chinese_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
				...
				$css .= aaa_chinese_parse_css( $button_patterns_compat_css );
				...
				if ( ! aaa_chinese_button_default_padding_updated() ) {
					...
					$css .= aaa_chinese_parse_css( $button_patterns_tablet_compat_css, '', aaa_chinese_get_tablet_breakpoint() );
					...
					$css .= aaa_chinese_parse_css( $button_patterns_mobile_compat_css, '', aaa_chinese_get_mobile_breakpoint() );
				}
				...
				$css .= aaa_chinese_parse_css( $gb_patterns_min_mobile_css );
			}

			if ( AAA_Chinese_Dynamic_CSS::gutenberg_core_blocks_css_comp() ) {
				...
				$css .= aaa_chinese_parse_css( $desktop_screen_gb_css );
				...
				if ( false === $improve_gb_ui ) {
					...
					$css .= aaa_chinese_parse_css( $middle_screen_min_gb_css, '1200' );
				}
				...
				$css .= aaa_chinese_parse_css( $middle_screen_max_gb_css, '', '1200' );
				...
				$css .= aaa_chinese_parse_css( $tablet_screen_min_gb_css, aaa_chinese_get_tablet_breakpoint() );
				...
				$css .= aaa_chinese_parse_css( $mobile_screen_max_gb_css, '', aaa_chinese_get_mobile_breakpoint() );
			}
			...
			if ( AAA_Chinese_Dynamic_CSS::gutenberg_core_patterns_compat() ) {
				...
				$css .= aaa_chinese_parse_css( $gb_editor_block_pattern_css );
			}
			...
			if ( true === $improve_gb_ui ) {
				...
				$css .= aaa_chinese_parse_css( $gb_editor_core_blocks_ui_css );
			} else {
				...
				$css .= AAA_Chinese_Enqueue_Scripts::trim_css( $block_editor_padding_css );
			}
			...
			$tablet_css = array(
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'tablet' ),
			);
			...
			$mobile_css = array(
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => aaa_chinese_get_responsive_background_obj( $box_bg_obj, 'mobile' ),
			);

			$css .= aaa_chinese_parse_css( $mobile_css, '', aaa_chinese_get_mobile_breakpoint() );

			if ( is_callable( 'AAA_Chinese_Woocommerce::aaa_chinese_global_btn_woo_comp' ) && AAA_Chinese_Woocommerce::aaa_chinese_global_btn_woo_comp() ) {
				...
				$css                  .= aaa_chinese_parse_css( $woo_global_button_css );
			}

			if ( aaa_chinese_wp_version_compare( '5.4.99', '>=' ) ) {
			...
			$css .= aaa_chinese_parse_css( $page_builder_css );
			...
			$css .= aaa_chinese_parse_css( $aligned_full_content_css );
			...
			$boxed_container = array(
				...
				'.ast-separate-container .editor-block-list__block, .ast-two-container .editor-block-list__block' => array(
					'max-width' => 'calc(' . aaa_chinese_get_css_value( $site_content_width, 'px' ) . ' - 6.67em)',
				),
			...
			if ( aaa_chinese_has_gcp_typo_preset_compatibility() ) {
				...
				$selector_for_content_background = true === $aaa_chinese_apply_content_background ? '.edit-post-visual-editor .editor-styles-wrapper' : $boxed_editor_content_area;

				$boxed_container[ $selector_for_content_background ] = aaa_chinese_get_responsive_background_obj( $content_bg_obj, 'desktop' );

				$boxed_container_tablet[ $selector_for_content_background ] = aaa_chinese_get_responsive_background_obj( $content_bg_obj, 'tablet' );

				$boxed_container_mobile[ $selector_for_content_background ] = aaa_chinese_get_responsive_background_obj( $content_bg_obj, 'mobile' );

				/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				$css .= aaa_chinese_parse_css( $boxed_container_tablet, '', aaa_chinese_get_tablet_breakpoint() );
				/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				$css .= aaa_chinese_parse_css( $boxed_container_mobile, '', aaa_chinese_get_mobile_breakpoint() );
			}

			$css .= aaa_chinese_parse_css( $boxed_container );
			...
			$css .= aaa_chinese_parse_css( $block_inserter_css );
			...
			if ( aaa_chinese_wp_version_compare( '5.4.99', '>=' ) ) {
				...
				$css .= aaa_chinese_parse_css( $block_pattern_css );
			} else {
				...
				$css .= aaa_chinese_parse_css( $full_width_streched_css );
			}
			...
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css .= aaa_chinese_parse_css( $ast_gtn_mobile_css, '', aaa_chinese_get_mobile_breakpoint() );
			...
			$css .= aaa_chinese_parse_css( $gtn_full_wide_image_css );
			...
			$css .= AAA_Chinese_Enqueue_Scripts::trim_css( $compatibility_css );
			...
			return $css . aaa_chinese_parse_css( $narrow_container );
		}
	}
