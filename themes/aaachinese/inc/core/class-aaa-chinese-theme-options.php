 ...
 * Theme Options
 */
if ( ! class_exists( 'AAA_Chinese_Theme_Options' ) ) {
	/**
	 * Theme Options
	 */
	class AAA_Chinese_Theme_Options {
		/**
		 * Class instance.
		 *
		 * @var AAA_Chinese_Theme_Options|null $instance Class instance.
		 */
		...
		/**
		 * A static theme aaachinese-options variable.
		 *
		 * @since 4.0.2
		 * @var mixed $aaa_chinese_options
		 */
		public static $aaa_chinese_options = null;
		...
		public static function defaults() {
			...
			/**
			 * Update AAA Chinese customizer default values. To not update directly on existing users site, added backwards.
			 *
			 * @since 3.6.3
			 */
			 ...
			 * @since 4.5.2
			 */
			$apply_scndry_default_padding_values = aaa_chinese_scndry_btn_default_padding();
			$update_secondary_paddings           = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_4_compatibility();
			$update_secondary_border             = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_8_0_compatibility();
			...
			$aaa_chinese_options        = self::get_aaa_chinese_options();
			$post_per_page        = intval( get_option( 'posts_per_page' ) );
			$blog_defaults_update = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_0_compatibility();
			$reorder_color_seq    = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_8_9_compatibility();

			// Update AAA Chinese heading 5 font size & handled backward case
			$update_heading_five_font_size  = AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_14_compatibility();
			...
			self::$defaults = apply_filters(
				...
				array(
					...
					'single-post-aaachinese-content-layout'       => $blog_defaults_update ? 'narrow-width-container' : 'default',
					'single-post-sidebar-style'            => $blog_defaults_update ? 'boxed' : 'default',
					'aaachinese-dynamic-single-post-elements-gap' => $blog_defaults_update ? 15 : 10,
					'aaachinese-dynamic-single-post-meta-font-size' => array(
					...
					'aaachinese-dynamic-single-post-meta-font-weight' => $blog_defaults_update ? '600' : '',
					'aaachinese-dynamic-single-post-metadata'     => $blog_defaults_update ? array(
						'author',
						'date',
					) : array(
						'comments',
					...
					'section-search-page-title-custom-title' => __( 'Search Results for:', 'aaachinese' ),
					'section-search-page-title-found-custom-description' => __( 'Here are the search results for your search.', 'aaachinese' ),
					'section-search-page-title-not-found-custom-description' => __( 'Sorry, but we could not find anything related to your search terms. Please try again.', 'aaachinese' ),
					...
					'aaachinese-search-results-per-page'          => 10,
					...
					'aaachinese-search-live-search'               => false,
					'aaachinese-search-live-search-post-types'    => array(
						'post' => 1,
						'page' => 1,
					),
					...
					'post-card-background-overlay'         => array(
						'background-type'  => '',
						'background-color' => aaa_chinese_get_option( 'post-card-featured-overlay' ), // fetch from old option.
					),
					...
					'button-radius-fields'                 => array(
						'desktop'      => array(
							'top'    => ! isset( $aaa_chinese_options['button-radius'] ) ? '' : $aaa_chinese_options['button-radius'],
							'right'  => ! isset( $aaa_chinese_options['button-radius'] ) ? '' : $aaa_chinese_options['button-radius'],
							'bottom' => ! isset( $aaa_chinese_options['button-radius'] ) ? '' : $aaa_chinese_options['button-radius'],
							'left'   => ! isset( $aaa_chinese_options['button-radius'] ) ? '' : $aaa_chinese_options['button-radius'],
						),
						'tablet'       => array(
							'top'    => '',
							'right'  => '',
					...
					'footer-sml-section-1-credit'          => __( 'Copyright &copy; [current_year] [site_title] | Powered by [theme_author]', 'aaachinese' ),
					'footer-sml-section-2'                 => '',
					'footer-sml-section-2-credit'          => __( 'Copyright &copy; [current_year] [site_title] | Powered by [theme_author]', 'aaachinese' ),
					'footer-sml-dist-equal-align'          => true,
					'footer-sml-divider'                   => 1,
					'footer-sml-divider-color'             => '#7a7a7a',
					'footer-layout-width'                  => 'content',
					// General.
					'aaachinese-header-retina-logo'               => '',
					...
					'aaachinese-header-logo-width'                => '',
					'aaachinese-header-responsive-logo-width'     => array(
						'desktop' => '',
						'tablet'  => '',
						'mobile'  => '',
					),
					'header-color-site-title'              => 'var(--aaachinese-global-color-2)',
					...
					'header-main-rt-section-html'          => '<button>' . __( 'Contact Us', 'aaachinese' ) . '</button>',
					'header-main-rt-section-button-text'   => __( 'Button', 'aaachinese' ),
					'header-main-rt-section-button-link-option' => array(
						'url'      => apply_filters( 'aaa_chinese_site_url', 'https://www.wpaaachinese.com' ),
						'new_tab'  => false,
						'link_rel' => '',
					),
					...
					// Site Layout.
					'site-layout'                          => 'aaachinese-full-width-layout',
					'site-content-width'                   => 1200,
					'narrow-container-max-width'           => 750,
					'site-layout-outside-bg-obj-responsive' => array(
						'desktop' => array(
							'background-color'      => $apply_new_default_values ? ( $reorder_color_seq ? 'var(--aaachinese-global-color-5)' : 'var(--aaachinese-global-color-4)' ) : '',
							'background-image'      => '',
							'background-repeat'     => 'repeat',
							'background-position'   => 'center center',
							'background-size'       => 'auto',
					...
					// Entry Content.
					'wp-blocks-ui'                         => false === aaa_chinese_check_is_structural_setup() ? 'custom' : 'comfort',
					...
					'aaachinese-sub-section-comments-margin'      => array(
						'desktop'      => array(
					...
					'aaachinese-sub-section-comments-padding'     => array(
						'desktop'      => array(
							'top'    => '',
							'right'  => '',
					...
					// Container.
					'single-page-aaachinese-content-layout'       => false === aaa_chinese_check_is_structural_setup() ? 'default' : 'normal-width-container',
					'single-page-content-style'            => false === aaa_chinese_check_is_structural_setup() ? 'default' : 'unboxed',
					'single-post-content-style'            => 'default',
					'archive-post-aaachinese-content-layout'      => 'default',
					'aaachinese-site-content-layout'              => 'normal-width-container',
					...
					'body-font-extras'                     => array(
						'line-height'         => ! isset( $aaa_chinese_options['body-font-extras'] ) && isset( $aaa_chinese_options['body-line-height'] ) ? $aaa_chinese_options['body-line-height'] : '1.65',
						'line-height-unit'    => AAA_Chinese_Dynamic_CSS::aaa_chinese_4_6_14_compatibility() ? '' : 'em',
						'letter-spacing'      => '',
						'letter-spacing-unit' => 'px',
						'text-transform'      => ! isset( $aaa_chinese_options['body-font-extras'] ) && isset( $aaa_chinese_options['body-text-transform'] ) ? $aaa_chinese_options['body-text-transform'] : '',
						'text-decoration'     => '',
					),
					'headings-font-extras'                 => array(
						'line-height'         => ! isset( $aaa_chinese_options['headings-font-extras'] ) && isset( $aaa_chinese_options['headings-line-height'] ) ? $aaa_chinese_options['headings-line-height'] : '',
						'line-height-unit'    => 'em',
						'letter-spacing'      => '',
						'letter-spacing-unit' => 'px',
						'text-transform'      => ! isset( $aaa_chinese_options['headings-font-extras'] ) && isset( $aaa_chinese_options['headings-text-transform'] ) ? $aaa_chinese_options['headings-text-transform'] : '',
						'text-decoration'     => '',
					),
					'para-margin-bottom'                   => '',
					...
					// Sidebar.
					'site-sidebar-layout'                  => false === aaa_chinese_check_old_sidebar_user() ? 'right-sidebar' : 'no-sidebar',
					'site-sidebar-width'                   => 30,
					'single-page-sidebar-layout'           => false === aaa_chinese_check_is_structural_setup() ? 'default' : 'no-sidebar',
					...
					'aaachinese-dynamic-single-download-structure' => true === aaa_chinese_enable_edd_featured_image_defaults() ? array(
						'aaachinese-dynamic-single-download-title',
						'aaachinese-dynamic-single-download-meta',
						'aaachinese-dynamic-single-download-image',
					) : array(
						'aaachinese-dynamic-single-download-title',
						'aaachinese-dynamic-single-download-meta',
					),
		...
		/**
		 * Get aaachinese-options DB values.
		 *
		 * @return array Return array of theme options from database.
		 *
		 * @since 4.0.0
		 */
		public static function get_aaa_chinese_options() {
			if ( is_null( self::$aaa_chinese_options ) || is_customize_preview() ) {
				self::$aaa_chinese_options = get_option( AAA_THEME_SETTINGS );
			}
			return self::$aaa_chinese_options;
		}
		...
		public static function get_db_options() {
			self::$db_options_no_defaults = self::get_aaa_chinese_options();
 ...
 */
AAA_Chinese_Theme_Options::get_instance();
