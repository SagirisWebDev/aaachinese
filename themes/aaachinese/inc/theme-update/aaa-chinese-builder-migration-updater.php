<?php
/**
 * AAA Chinese builder migration updates
 *
 ...
 * @return void
 */
function aaa_chinese_header_builder_migration() {
	...
	$options = aaa_chinese_primary_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_below_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_above_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_footer_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_footer_widgets_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_primary_menu_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$options = aaa_chinese_sticky_header_builder_migration( $options['theme_options'], $options['used_elements'], $options['widget_options'] );
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
 ...
 * @return array
 */
function aaa_chinese_primary_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	...
	$mobile_layout = aaa_chinese_get_option( 'header-main-menu-align' );
 ...
 * @return array
 */
function aaa_chinese_below_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Below Header
	 */
 ...
 * @return array
 */
function aaa_chinese_above_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Above Header.
	 */
 ...
 * @return array
 */
function aaa_chinese_footer_builder_migration( $theme_options, $used_elements, $widget_options ) {
	/**
	 * Footer
	 */
 ...
 * @return array
 */
function aaa_chinese_footer_widgets_migration( $theme_options, $used_elements, $widget_options ) {
 ...
 * @return array
 */
function aaa_chinese_primary_menu_builder_migration( $theme_options, $used_elements, $widget_options ) {
 ...
 * @return array
 */
function aaa_chinese_sticky_header_builder_migration( $theme_options, $used_elements, $widget_options ) {
