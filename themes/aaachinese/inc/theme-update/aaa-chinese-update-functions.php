 ...
 * @return void.
 */
function aaa_chinese_clear_all_assets_cache() {
	if ( ! class_exists( 'AAA_Chinese_Cache_Base' ) ) {
		return;
	}
	// Clear AAA Chinese theme asset cache.
	$aaa_chinese_cache_base_instance = new AAA_Chinese_Cache_Base( 'astra' );
	$aaa_chinese_cache_base_instance->refresh_assets( 'astra' );

	// Clear AAA Chinese Addon's static and dynamic CSS asset cache.
	$aaa_chinese_addon_cache_base_instance = new AAA_Chinese_Cache_Base( 'astra-addon' );
	$aaa_chinese_addon_cache_base_instance->refresh_assets( 'astra-addon' );
}
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_0_0() {
	...
	$admin_dashboard_settings = get_option( 'aaa_chinese_admin_settings', array() );
	if ( ! isset( $admin_dashboard_settings['theme-setup-admin-migrated'] ) ) {
		...
		update_option( 'aaa_chinese_admin_settings', $admin_dashboard_settings );
	}
	...
	if ( defined( 'AAA_EXT_VER' ) && AAA_Chinese_Ext_Extension::is_active( 'scroll-to-top' ) ) {
		/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_0_2() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_1_0() {
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_1_4() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_1_6() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_1_7() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_2_0() {
	$theme_options = get_option( 'astra-settings', array() );
	if ( ! isset( $theme_options['v4-2-0-update-migration'] ) ) {
		...
		if ( isset( $theme_options['site-content-layout'] ) ) {
			$theme_options = aaa_chinese_apply_layout_migration( 'site-content-layout', 'ast-site-content-layout', 'site-content-style', 'site-sidebar-style', $theme_options );
		}
		...
		foreach ( $blog_types as $blog_type ) {
			foreach ( $post_types as $post_type ) {
				...
				if ( isset( $theme_options[ $old_layout ] ) ) {
					$theme_options = aaa_chinese_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options );
				}
			}
		}
		...
		foreach ( $third_party_layouts as $layout ) {
			...
			if ( isset( $theme_options[ $old_layout ] ) ) {
				if ( 'lifterlms' === $layout ) {
					...
					$theme_options = aaa_chinese_apply_layout_migration( $old_layout, $new_layout, $content_style, 'lifterlms-course-lesson-sidebar-style', $theme_options );
				}
				$theme_options = aaa_chinese_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options );
			}
		}
 ...
 */
function aaa_chinese_apply_layout_migration( $old_layout, $new_layout, $content_style, $sidebar_style, $theme_options ) {
	switch ( aaa_chinese_get_option( $old_layout ) ) {
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_2_2() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_4_0() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_5_0() {
	$theme_options = get_option( 'astra-settings', array() );

	if ( ! isset( $theme_options['v4-5-0-backward-option'] ) ) {
		$theme_options['v4-5-0-backward-option'] = false;

		$palette_options = get_option( 'astra-color-palettes', AAA_Chinese_Global_Palette::get_default_color_palette() );
		if ( ! isset( $palette_options['presets'] ) ) {
			$palette_options['presets'] = aaa_chinese_get_palette_presets();
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_5_2() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_0() {
	$theme_options = get_option( 'astra-settings', array() );
	...
	$docs_legacy_data = get_option( 'aaa_chinese_docs_data', array() );
	if ( ! empty( $docs_legacy_data ) ) {
		delete_option( 'aaa_chinese_docs_data' );
	}
}
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_2() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_4() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_5() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_6() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_11() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_12() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_6_14() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_7_0() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_7_1() {
	$theme_options = get_option( 'astra-settings', array() );
...
/**
 * Handle backward compatibility Spectra Heading max-width with AAA Chinese when fullwidth layout is selected.
 *
 * @since 4.8.0
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_0() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_2() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_4() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_7() {

	// Bail early if the starter template is being imported.
	if ( get_option( 'aaa_chinese_sites_import_started' ) === 'yes' ) {
		return;
	}

	update_option( 'aaa_chinese_nps_show', true );
}
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_9() {
	// Bail early if the starter template is being imported.
	if ( get_option( 'aaa_chinese_sites_import_started' ) === 'yes' || aaa_chinese_get_option( 'new-color-labels' ) ) {
		aaa_chinese_update_option( 'new-color-labels', true );
	}
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_8_10() {
	$theme_options = get_option( 'astra-settings', array() );
	/**
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_9_0() {
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_10_0() {
	...
	$analytics_options = array(
		'bsf_analytics_installed_time' => 'aaa_chinese_usage_installed_time',
		'bsf_analytics_optin'          => 'aaa_chinese_usage_optin',
	);
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_11_6() {
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_11_12() {
	// Set button consistency backward compatibility flag.
	$theme_options = get_option( 'astra-settings', array() );
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_12_0() {
	$theme_options = aaa_chinese_get_options();
 ...
 * @return void
 */
function aaa_chinese_theme_background_updater_4_12_2() {
	// Retrieve the installed time and optin status of BSF Analytics and update it as per new key option.
	$analytics_options = array(
		'aaa_chinese_analytics_installed_time' => 'aaa_chinese_usage_installed_time',
		'aaa_chinese_analytics_optin'          => 'aaa_chinese_usage_optin',
	);
