 ...
 */
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_ext_transparent_above_header_sections_dynamic_css' );
 ...
 */
function aaa_chinese_ext_transparent_above_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	$above_header_layout = aaa_chinese_get_option( 'above-header-layout', 'disabled' );

	if ( 'disabled' === $above_header_layout ) {
		return $dynamic_css;
	}

	if ( false == AAA_Chinese_Ext_Transparent_Header_Markup::is_transparent_header() ) {
		return $dynamic_css;
	}
	...
	$transparent_bg_color_tablet  = aaa_chinese_get_prop( aaa_chinese_get_option( 'transparent-header-bg-color-responsive' ), 'tablet' );
	$transparent_bg_color_mobile  = aaa_chinese_get_prop( aaa_chinese_get_option( 'transparent-header-bg-color-responsive' ), 'mobile' );
 ...
 */
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_ext_transparent_below_header_sections_dynamic_css' );
 ...
 */
function aaa_chinese_ext_transparent_below_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	// set page width depending on site layout.
	$below_header_layout = aaa_chinese_get_option( 'below-header-layout', 'disabled' );
