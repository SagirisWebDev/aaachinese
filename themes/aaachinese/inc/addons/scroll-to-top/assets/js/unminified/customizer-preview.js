...
( function( $ ) {
	...
	aaa_chinese_css( 'astra-settings[scroll-to-top-icon-color]', 'color', '#ast-scroll-top' );
	aaa_chinese_css( 'astra-settings[scroll-to-top-icon-bg-color]', 'background-color', '#ast-scroll-top' );
	aaa_chinese_css( 'astra-settings[scroll-to-top-icon-h-color]', 'color', '#ast-scroll-top:hover' );
	aaa_chinese_css( 'astra-settings[scroll-to-top-icon-h-bg-color]', 'background-color', '#ast-scroll-top:hover' );
	...
	wp.customize( 'astra-settings[scroll-to-top-icon-radius-fields]', function( value ) {
		value.bind( function( border ) {
			...
			aaa_chinese_add_dynamic_css( 'scroll-to-top-icon-radius-fields', dynamicStyle );
		} );
	} );
