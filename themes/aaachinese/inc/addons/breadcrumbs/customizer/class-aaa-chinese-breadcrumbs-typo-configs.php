 ...
 * @since 1.7.0
 */
if ( ! class_exists( 'AAA_Chinese_Breadcrumbs_Typo_Configs' ) ) {

	/**
	 * Register Colors and Background - Breadcrumbs Options Customizer Configurations.
	 */
	class AAA_Chinese_Breadcrumbs_Typo_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register Colors and Background - Breadcrumbs Options Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'      => AAA_THEME_SETTINGS . '[section-breadcrumb-typo]',
					'default'   => aaa_chinese_get_option( 'section-breadcrumb-typo' ),
					'type'      => 'control',
				...
				array(
					...
					'default'   => aaa_chinese_get_option( 'breadcrumb-font-family' ),
					'type'      => 'sub-control',
					'parent'    => AAA_THEME_SETTINGS . '[section-breadcrumb-typo]',
					'section'   => 'section-breadcrumb',
					'control'   => 'ast-font',
				...
				array(
					...
					'default'           => aaa_chinese_get_option( 'breadcrumb-font-weight' ),
				...
				array(
					...
					'priority'          => 10,
					'default'           => aaa_chinese_get_option( 'breadcrumb-font-size' ),
 ...
 */
new AAA_Chinese_Breadcrumbs_Typo_Configs();
