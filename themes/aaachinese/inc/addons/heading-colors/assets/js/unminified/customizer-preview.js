...
( function( $ ) {
	 ...
	 */
	aaa_chinese_css( 'astra-settings[heading-base-color]', 'color', headingSelectors );
	...
	function headingDynamicCss(slug) {
		...
		aaa_chinese_generate_outside_font_family_css( 'astra-settings[font-family-'+ slug +']', slug + ', .entry-content ' + slug + anchorSupport, true, '.ast-sg-typo-field[data-for="' + slug + '"] .ast-sg-font-family' );
		aaa_chinese_generate_font_weight_css( 'astra-settings[font-family-'+ slug +']', 'astra-settings[font-weight-'+ slug +']', 'font-weight', slug + ', .entry-content ' + slug + anchorSupport + WidthTitleSupport );
			...
			value.bind( function( data ) {
				...
				if ( astraCustomizer.page_builder_button_style_css ) {
					...
					if( data['line-height'] && data['line-height-unit'] ) {
						...
						let styleGuideUpdatedEvent = new CustomEvent('AAA ChineseStyleGuideElementUpdated', {
							'detail': {
					...
					aaa_chinese_add_dynamic_css( 'font-extras-'+ slug, dynamicStyle );
			});
		});
	}
	...
	if( astraCustomizer.aaa_chinese_woo_btn_global_compatibility ) {
	...
	if ( astraCustomizer.page_builder_button_style_css ) {
		...
		aaa_chinese_font_extras_css( 'font-extras-button', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"], body .wp-block-button .wp-block-button__link, form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button' + astraCustomizer.v4_2_2_core_form_btns_styling + ele_btn_transform + woo_button_attr + astraCustomizer.improved_button_selector );
		...
		// Button Typo
		aaa_chinese_generate_outside_font_family_css( 'astra-settings[font-family-button]', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr );
		aaa_chinese_generate_font_weight_css( 'astra-settings[font-family-button]', 'astra-settings[font-weight-button]', 'font-weight', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr );
		aaa_chinese_font_extras_css( 'font-extras-button', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr );
		aaa_chinese_responsive_font_size( 'astra-settings[font-size-button]', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr );
		aaa_chinese_css( 'astra-settings[theme-btn-line-height]', 'line-height', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr );
		aaa_chinese_css( 'astra-settings[theme-btn-letter-spacing]', 'letter-spacing', 'button, .ast-button, .ast-custom-button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' + astraCustomizer.v4_2_2_core_form_btns_styling + woo_button_attr , 'px' );
	}
	...
	aaa_chinese_generate_outside_font_family_css( 'astra-settings[secondary-font-family-button]', outline_btn_selector );
	aaa_chinese_generate_font_weight_css( 'astra-settings[secondary-font-family-button]', 'astra-settings[secondary-font-weight-button]', 'font-weight', outline_btn_selector );
	aaa_chinese_font_extras_css( 'secondary-font-extras-button', outline_btn_selector );
	aaa_chinese_responsive_font_size( 'astra-settings[secondary-font-size-button]', outline_btn_selector );
	aaa_chinese_css( 'astra-settings[secondary-theme-btn-line-height]', 'line-height', outline_btn_selector );
	aaa_chinese_css( 'astra-settings[secondary-theme-btn-letter-spacing]', 'letter-spacing', outline_btn_selector, 'px' );
