 ...
 * Heading Colors
 */
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_heading_colors_section_dynamic_css' );
 ...
 * @since 2.1.4
 */
function aaa_chinese_heading_colors_section_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$css_output = aaa_chinese_parse_css( $css_output );
