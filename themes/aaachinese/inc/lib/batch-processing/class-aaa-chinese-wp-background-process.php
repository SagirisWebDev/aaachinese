...
if ( ! class_exists( 'AAA_Chinese_WP_Background_Process' ) ) {
	...
	/**
	 * Abstract AAA_Chinese_WP_Background_Process class.
	 *
	 * @abstract
	 * @extends AAA_Chinese_WP_Async_Request
	 */
	abstract class AAA_Chinese_WP_Background_Process extends AAA_Chinese_WP_Async_Request {
