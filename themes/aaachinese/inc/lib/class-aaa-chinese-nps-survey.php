...
if ( ! class_exists( 'AAA_Chinese_Nps_Survey' ) ) {

	/**
	 * Admin
	 */
	class AAA_Chinese_Nps_Survey {
		/**
		 * Instance
		 *
		 * @since 1.0.0
		 * @var (Object) AAA_Chinese_Nps_Survey
		 */
		...
		private function __construct() {
			...
			if ( apply_filters( 'aaa_chinese_nps_survey_disable', false ) ) {
				return;
			}
	 ...
	 */
	AAA_Chinese_Nps_Survey::get_instance();
