...
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_navigation_css', 11 );
 ...
 * @since 4.6.0
 */
function aaa_chinese_navigation_css( $dynamic_css ) {
	$mobile_breakpoint = strval( aaa_chinese_get_mobile_breakpoint() );
	$link_hover_color  = aaa_chinese_get_option( 'link-h-color' );

	/** Backward compatibility support for left-right paddings @since 4.6.13 */
	$remove_mobile_device_paddings = apply_filters( 'aaa_chinese_remove_single_posts_navigation_mobile_device_padding', ! empty( aaa_chinese_get_option( 'remove_single_posts_navigation_mobile_device_padding' ) ) );
	...
	$dynamic_css .= AAA_Chinese_Enqueue_Scripts::trim_css( $navigation_css );
