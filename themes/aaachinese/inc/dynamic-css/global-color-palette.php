...
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_generate_global_palette_style' );
 ...
 * @return string
 */
function aaa_chinese_generate_global_palette_style( $dynamic_css ) {

	$global_palette   = aaa_chinese_get_option( 'global-color-palette' );
	$palette_style    = array();
	$variable_prefix  = AAA_Chinese_Global_Palette::get_css_variable_prefix();
	 ...
	 * @since 4.10.0
	 */
	$global_palette = apply_filters( 'aaa_chinese_global_current_palette', $global_palette );
	...
	$dynamic_css           .= aaa_chinese_parse_css( $palette_style );
