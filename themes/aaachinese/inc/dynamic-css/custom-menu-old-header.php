...
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_old_header_custom_menu_css' );
 ...
 * @since 3.5.0
 */
function aaa_chinese_old_header_custom_menu_css( $dynamic_css ) {
	...
	if ( false === AAA_Chinese_Builder_Helper::$is_header_footer_builder_active ) {
		...
		$search_box_type = aaa_chinese_get_option( 'header-main-rt-section-search-box-type' );
