...
add_filter( 'aaa_chinese_dynamic_theme_css', 'aaa_chinese_dark_palette_css', 11 );
 ...
 * @since 4.9.0
 */
function aaa_chinese_dark_palette_css( $dynamic_css, $force = false ) {
	/**
	...
	if ( AAA_Chinese_Global_Palette::is_dark_palette() || $force ) {
		...
		$dynamic_css .= aaa_chinese_parse_css( $dark_palette_common_dynamic_css );
	}
