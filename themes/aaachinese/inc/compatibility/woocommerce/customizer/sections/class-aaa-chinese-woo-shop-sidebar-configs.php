...
if ( ! class_exists( 'AAA_Chinese_Woo_Shop_Sidebar_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Woo_Shop_Sidebar_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register AAA Chinese-WooCommerce Shop Sidebar Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[woocommerce-sidebar-layout]',
					'type'              => 'control',
					'control'           => 'ast-radio-image',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_choices' ),
					'section'           => 'section-woo-general',
					'default'           => aaa_chinese_get_option( 'woocommerce-sidebar-layout' ),
					'priority'          => 5,
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[woocommerce-sidebar-style]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => 'section-woo-general',
					'default'    => aaa_chinese_get_option( 'woocommerce-sidebar-style', 'default' ),
					'priority'   => 5,
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[shop-display-options-divider]',
...
new AAA_Chinese_Woo_Shop_Sidebar_Configs();
