...
if ( ! class_exists( 'AAA_Chinese_Woo_Shop_Single_Layout_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Woo_Shop_Single_Layout_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register AAA Chinese-WooCommerce Shop Single Layout Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$product_divider_title = aaa_chinese_has_pro_woocommerce_addon() ? __( 'Product Structure Options', 'astra' ) : __( 'Product Options', 'astra' );
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-single-product-structure-divider]',
					'section'  => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[single-product-structure]',
					'default'           => aaa_chinese_get_option( 'single-product-structure' ),
					'type'              => 'control',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-single-product-structure-fields-divider]',
					'section'  => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[single-product-breadcrumb-disable]',
					'section'  => 'section-woo-shop-single',
					'type'     => 'control',
					'control'  => 'ast-toggle-control',
					'default'  => aaa_chinese_get_option( 'single-product-breadcrumb-disable' ),
				 ...
				 */
				array(
					'name'        => AAA_THEME_SETTINGS . '[single-product-enable-shipping]',
					'default'     => aaa_chinese_get_option( 'single-product-enable-shipping' ),
					'type'        => 'control',
					'section'     => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'        => AAA_THEME_SETTINGS . '[single-product-variation-tabs-layout]',
					'default'     => aaa_chinese_get_option( 'single-product-variation-tabs-layout' ),
					'type'        => 'control',
					'section'     => 'section-woo-shop-single',
				...
				array(
					...
					'default'  => aaa_chinese_get_option( 'transparent-header-disable-woo-products' ),
					'type'     => 'sub-control',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[single-product-shipping-text]',
					'default'  => aaa_chinese_get_option( 'single-product-shipping-text' ),
					'type'     => 'control',
					'section'  => 'section-woo-shop-single',
					...
					'context'  => array(
						AAA_Chinese_Builder_Helper::$general_tab_config,
						array(
							'setting'  => AAA_THEME_SETTINGS . '[single-product-enable-shipping]',
							'operator' => '==',
							'value'    => true,
						),
					),
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-divider]',
					'section'  => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart]',
					'default'  => aaa_chinese_get_option( 'single-product-sticky-add-to-cart' ),
					'type'     => 'control',
					'section'  => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-position]',
					'default'    => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-position' ),
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => 'section-woo-shop-single',
					'priority'   => 76,
					...
					'context'    => array(
						AAA_Chinese_Builder_Helper::$general_tab_config,
						array(
							'setting'  => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart]',
							'operator' => '==',
							'value'    => true,
						),
					),
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-single-product-sticky-color-divider]',
					'section'  => 'section-woo-shop-single',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-text-color]',
					'default'           => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-text-color' ),
					'type'              => 'control',
					'section'           => 'section-woo-shop-single',
					'control'           => 'ast-color',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-bg-color]',
					'default'           => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-bg-color' ),
					'type'              => 'control',
					'section'           => 'section-woo-shop-single',
					'control'           => 'ast-color',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_alpha_color' ),
				 ...
				 */
				array(
					'name'      => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-btn-color]',
					'default'   => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-color' ),
					'type'      => 'control',
				...
				array(
					'type'     => 'sub-control',
					'priority' => 76,
					'parent'   => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-btn-color]',
					'section'  => 'section-woo-shop-single',
					'control'  => 'ast-color',
					'default'  => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-n-color' ),
				...
				array(
					...
					'control'           => 'ast-color',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_alpha_color' ),
					'default'           => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-h-color' ),
					'transport'         => 'postMessage',
				 ...
				 */
				array(
					'name'      => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-btn-bg-color]',
					'default'   => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-bg-color' ),
					'type'      => 'control',
					'control'   => 'ast-color-group',
				...
				array(
					'type'     => 'sub-control',
					'priority' => 82,
					'parent'   => AAA_THEME_SETTINGS . '[single-product-sticky-add-to-cart-btn-bg-color]',
					'section'  => 'section-woo-shop-single',
					'control'  => 'ast-color',
					'default'  => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-bg-n-color' ),
				...
				array(
					...
					'control'           => 'ast-color',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_alpha_color' ),
					'default'           => aaa_chinese_get_option( 'single-product-sticky-add-to-cart-btn-bg-h-color' ),
					'transport'         => 'postMessage',
				...
				array(
					...
					'parent'     => AAA_THEME_SETTINGS . '[single-product-structure]',
					'default'    => aaa_chinese_get_option( 'single-product-payment-icon-color' ),
				...
				array(
					...
					'parent'    => AAA_THEME_SETTINGS . '[single-product-structure]',
					'default'   => aaa_chinese_get_option( 'single-product-payment-text' ),
					'linked'    => 'single-product-payments',
					'type'      => 'sub-control',
			...
			$_configs[] = array(
				...
				'parent'      => AAA_THEME_SETTINGS . '[single-product-structure]',
				'default'     => aaa_chinese_get_option( 'single-product-payment-list' ),
				'linked'      => 'single-product-payments',
				'type'        => 'sub-control',
			...
			$_configs[] = array(
				...
				'parent'      => AAA_THEME_SETTINGS . '[single-product-structure]',
				'default'     => aaa_chinese_get_option( 'single-product-cart-button-width' ),
				'linked'      => 'add_cart',
				'type'        => 'sub-control',
			...
			if ( aaa_chinese_has_pro_woocommerce_addon() ) {
				...
				$_configs[] = array(
					'name'        => AAA_THEME_SETTINGS . '[single-product-cart-button-width]',
					'default'     => aaa_chinese_get_option( 'single-product-cart-button-width' ),
					'type'        => 'control',
					'transport'   => 'postMessage',
					'responsive'  => true,
			...
			if ( ! defined( 'AAA_EXT_VER' ) ) {
				$_configs[] = array(
					'name'     => AAA_THEME_SETTINGS . '[sticky-add-to-cart-notice]',
					'type'     => 'control',
				...
				if ( aaa_chinese_showcase_upgrade_notices() ) {
					...
					$_configs[] = array(
						'name'      => AAA_THEME_SETTINGS . '[ast-woo-single-product-pro-items]',
						'type'      => 'control',
						'control'   => 'ast-upgrade',
						...
						'divider'   => array( 'ast_class' => 'ast-top-section-divider' ),
						'context'   => array(),
						'thumbnail' => AAA_THEME_URI . 'inc/assets/images/customizer/woo-single.png',
					);
				}
			}
...
new AAA_Chinese_Woo_Shop_Single_Layout_Configs();
