...
if ( ! class_exists( 'AAA_Chinese_Woo_Shop_Cart_Layout_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Woo_Shop_Cart_Layout_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register AAA Chinese-WooCommerce Shop Cart Layout Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'        => AAA_THEME_SETTINGS . '[woo-enable-cart-button-text]',
					'default'     => aaa_chinese_get_option( 'woo-enable-cart-button-text' ),
					'type'        => 'control',
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-cart-button-text]',
					'default'  => aaa_chinese_get_option( 'woo-cart-button-text' ),
					'type'     => 'control',
					'section'  => 'section-woo-shop-cart',
					...
					'context'  => array(
						...
						array(
							'setting'  => AAA_THEME_SETTINGS . '[woo-enable-cart-button-text]',
							'operator' => '==',
							'value'    => true,
						),
					),
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[enable-cart-upsells]',
					'section'  => 'section-woo-shop-cart',
					'type'     => 'control',
					'control'  => 'ast-toggle-control',
					'default'  => aaa_chinese_get_option( 'enable-cart-upsells' ),
			...
			if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '8.3', '>=' ) ) {
				$_configs[] = array(
					'name'     => AAA_THEME_SETTINGS . '[woo-block-incompatible-cart-notice]',
					'type'     => 'control',
				...
				$_configs[] = array(
					'name'     => AAA_THEME_SETTINGS . '[woo-block-incompatible-checkout-notice]',
					'type'     => 'control',
					'control'  => 'ast-description',
			...
			if ( aaa_chinese_showcase_upgrade_notices() ) {
				...
				$_configs[] = array(
					'name'      => AAA_THEME_SETTINGS . '[ast-woo-cart-pro-items]',
					'type'      => 'control',
					'control'   => 'ast-upgrade',
					...
					'context'   => array(),
					'thumbnail' => AAA_THEME_URI . 'inc/assets/images/customizer/woo-cart.png',
				);

				$_configs[] = array(
					'name'      => AAA_THEME_SETTINGS . '[ast-woo-checkout-pro-items]',
					'type'      => 'control',
					'control'   => 'ast-upgrade',
					'campaign'  => 'woocommerce',
					'choices'   => array(
					...
					'divider'   => array( 'ast_class' => 'ast-top-section-divider' ),
					'context'   => array(),
					'thumbnail' => AAA_THEME_URI . 'inc/assets/images/customizer/woo-checkout.png',
				);
			}
...
new AAA_Chinese_Woo_Shop_Cart_Layout_Configs();
