...
if ( ! class_exists( 'AAA_Chinese_Woo_Shop_Layout_Configs' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class AAA_Chinese_Woo_Shop_Layout_Configs extends AAA_Chinese_Customizer_Config_Base {
		/**
		 * Register AAA Chinese-WooCommerce Shop Layout Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$aaa_chinese_addon_with_woo = aaa_chinese_has_pro_woocommerce_addon() ? true : false;
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

			$add_to_cart_attr             = array();
			$ratings                      = array();
			$aaa_chinese_shop_page_pro_features = array();

			if ( $aaa_chinese_addon_with_woo ) {
				$aaa_chinese_shop_page_pro_features = array(
			...
			if ( $aaa_chinese_addon_with_woo ) {
				$current_shop_layouts = array(
					'shop-page-grid-style'   => array(
						...
						'path'  => class_exists( 'AAA_Chinese_Builder_UI_Controller' ) ? AAA_Chinese_Builder_UI_Controller::fetch_svg_icon( 'shop-grid-view', false ) : '',
					),
					'shop-page-modern-style' => array(
						'label' => __( 'Design 2', 'astra' ),
						'path'  => class_exists( 'AAA_Chinese_Builder_UI_Controller' ) ? AAA_Chinese_Builder_UI_Controller::fetch_svg_icon( 'shop-modern-view', false ) : '',
					),
					'shop-page-list-style'   => array(
						'label' => __( 'Design 3', 'astra' ),
						'path'  => class_exists( 'AAA_Chinese_Builder_UI_Controller' ) ? AAA_Chinese_Builder_UI_Controller::fetch_svg_icon( 'shop-list-view', false ) : '',
					),
				);
			} else {
				$current_shop_layouts = array(
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[shop-box-styling]',
					'section'  => 'woocommerce_product_catalog',
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[shop-product-align-responsive]',
					'default'    => aaa_chinese_get_option( 'shop-product-align-responsive' ),
					'type'       => 'control',
					...
					'divider'    => ! defined( 'AAA_EXT_VER' ) ? array() : array( 'ast_class' => 'ast-bottom-section-divider' ),
				),
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-shop-structure-divider]',
					'section'  => 'woocommerce_product_catalog',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[shop-product-structure]',
					'type'              => 'control',
					'control'           => 'ast-sortable',
					'sanitize_callback' => array( 'AAA_Chinese_Customizer_Sanitizes', 'sanitize_multi_choices' ),
					'section'           => 'woocommerce_product_catalog',
					'default'           => aaa_chinese_get_option( 'shop-product-structure' ),
					'priority'          => 15,
					'choices'           => array_merge(
						array(
				 ...
				 */
				array(
					'name'     => AAA_THEME_SETTINGS . '[woo-shop-skin-divider]',
					'section'  => 'woocommerce_product_catalog',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[shop-style]',
					'default'           => aaa_chinese_get_option( 'shop-style' ),
					'type'              => 'control',
					'section'           => 'woocommerce_product_catalog',
				 ...
				 */
				array(
					'name'              => AAA_THEME_SETTINGS . '[shop-grids]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'         => AAA_THEME_SETTINGS . '[shop-no-of-products]',
					'type'         => 'control',
					'section'      => 'woocommerce_product_catalog',
					'title'        => __( 'Products Per Page', 'astra' ),
					'default'      => aaa_chinese_get_option( 'shop-no-of-products' ),
					'control'      => 'ast-number',
					'qty_selector' => true,
					'priority'     => 9,
					'input_attrs'  => array(
				 ...
				 */
				array(
					'name'       => AAA_THEME_SETTINGS . '[shop-archive-width]',
					'type'       => 'control',
					'control'    => 'ast-selector',
					'section'    => 'woocommerce_product_catalog',
					'default'    => aaa_chinese_get_option( 'shop-archive-width' ),
					'priority'   => 9,
					...
					'renderAs'   => 'text',
					'responsive' => false,
					'divider'    => $aaa_chinese_addon_with_woo ? array( 'ast_class' => 'ast-top-section-divider' ) : array( 'ast_class' => 'ast-section-spacing' ),
				),
				 ...
				 */
				array(
					'name'        => AAA_THEME_SETTINGS . '[shop-archive-max-width]',
					'type'        => 'control',
					'control'     => 'ast-slider',
					'section'     => 'woocommerce_product_catalog',
					'default'     => aaa_chinese_get_option( 'shop-archive-max-width' ),
					'priority'    => 9,
					...
					'context'     => array(
						...
						array(
							'setting'  => AAA_THEME_SETTINGS . '[shop-archive-width]',
							'operator' => '===',
							'value'    => 'custom',
						),
					),
			...
			$_configs[] = array(
				...
				'parent'     => AAA_THEME_SETTINGS . '[shop-product-structure]',
				'default'    => aaa_chinese_get_option( 'shop-add-to-cart-action' ),
				'section'    => 'woocommerce_product_catalog',
				...
				'choices'    => array_merge(
					...
					$aaa_chinese_shop_page_pro_features
				),
				'responsive' => false,
				'renderAs'   => 'text',
				'transport'  => 'postMessage',
				...
				$_configs[] = array(
					...
					'parent'     => AAA_THEME_SETTINGS . '[shop-product-structure]',
					'default'    => aaa_chinese_get_option( 'shop-ratings-product-archive' ),
					'linked'     => 'ratings',
					'type'       => 'sub-control',
					'control'    => 'ast-selector',
					'section'    => 'woocommerce_product_catalog',
				...
				if ( aaa_chinese_showcase_upgrade_notices() ) {
					$_configs[] = array(
						'name'      => AAA_THEME_SETTINGS . '[ast-woo-shop-pro-items]',
						'type'      => 'control',
						'control'   => 'ast-upgrade',
						...
						'divider'   => array( 'ast_class' => 'ast-top-section-divider' ),
						'context'   => array(),
						'thumbnail' => AAA_THEME_URI . 'inc/assets/images/customizer/woo-catalog.png',
					);
				}
...
new AAA_Chinese_Woo_Shop_Layout_Configs();
