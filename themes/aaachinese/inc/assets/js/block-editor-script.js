...
function aaa_chinese_onload_function() {

	/* Do things after DOM has fully loaded */

	var astraMetaBox = document.querySelector( '#aaa_chinese_settings_meta_box' );
	...
	wp.data.subscribe(function () {
		setTimeout( function () {
			...
			if ( astraColors.is_aaa_chinese_pro_colors_activated ) {
	...
	if ( document && document.body ) {
		const isSiteBuilderLayout = document.body.classList.contains( 'post-type-aaa-chinese-advanced-hook' );
