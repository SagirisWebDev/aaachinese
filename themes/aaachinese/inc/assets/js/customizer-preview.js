...
wp.customize( 'astra-settings[blog-single-width]', function( value ) {
    value.bind( function( value ) {
        ...
        aaa_chinese_add_dynamic_css( 'blog-single-width', dynamicStyle );
    } );
} );
...
wp.customize( 'astra-settings[blog-width]', function( value ) {
    value.bind( function( value ) {
        ...
        aaa_chinese_add_dynamic_css( 'blog-width', dynamicStyle );
    } );
} );
...
wp.customize( 'astra-settings[edd-archive-width]', function( value ) {
    value.bind( function( value ) {
        ...
        aaa_chinese_add_dynamic_css( 'edd-archive-width', dynamicStyle );
    } );
} );

// WooCommerce store notice color configs.
aaa_chinese_css( 'astra-settings[store-notice-text-color]', 'color', 'body p.demo_store, body .woocommerce-store-notice, body p.demo_store a, body .woocommerce-store-notice a' );
aaa_chinese_css( 'astra-settings[store-notice-background-color]', 'background-color', 'body p.demo_store, body .woocommerce-store-notice, body p.demo_store a, body .woocommerce-store-notice a' );
